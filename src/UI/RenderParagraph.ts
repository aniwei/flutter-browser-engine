...
type TextHeightBehaviorOptions = {
...
export class RenderParagraph extends RenderBox {
  constructor (options: RenderParagraphOptions) {
    options.textAlign ??= TextAlign.Start
    options.softWrap ??= true
    options.overflow ??= TextOverflow.Clip
    options.textScaleFactor ??= 1.0
    options.textWidthBasis = TextWidthBasis.Parent
