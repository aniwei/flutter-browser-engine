define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/rendering/viewport_offset.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/gestures/hit_test.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/painting/matrix_utils.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/semantics/semantics.dart'], (function load__packages__flutter__src__rendering__sliver_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__rendering__viewport_offset$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__gestures__hit_test$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__painting__matrix_utils$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__semantics__semantics$46dart) {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/rendering/sliver.dart",
    "package:flutter/src/rendering/viewport.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/rendering/viewport.dart"
  ];
      ...
      if (!dart.fn(() => {
        ...
        if (hasErrors) {
          dart.throw(new assertions.FlutterError.fromParts((() => {
            ...
            t0.push(new (T.DiagnosticsPropertyOfSliverConstraints()).new("The offending constraints were", this, {style: diagnostics.DiagnosticsTreeStyle.errorProperty}));
            return t0;
          })()));
        }
        return true;
  ...
  sliver$._debugCompareFloats = function _debugCompareFloats(labelA, valueA, labelB, valueB) {
    return (() => {
      ...
      if (valueA[$toStringAsFixed](1) !== valueB[$toStringAsFixed](1))
        t6.push(new assertions.ErrorDescription.new("The " + labelA + " is " + valueA[$toStringAsFixed](1) + ", but " + "the " + labelB + " is " + valueB[$toStringAsFixed](1) + "."));
      else
  ...
  viewport.RenderViewportBase$ = dart.generic(ParentDataClass => {
    ...
    class RenderViewportBase extends RenderBox_ContainerRenderObjectMixin$36 {
      ...
      hitTestChildren(result, opts) {
        ...
        if (!(mainAxisPosition !== null)) dart.assertFailed(null, I[3], 705, 12, "mainAxisPosition != null");
        if (!(crossAxisPosition !== null)) dart.assertFailed(null, I[3], 706, 12, "crossAxisPosition != null");
      ...
      getOffsetToReveal(target, alignment, opts) {
        ...
        while (!dart.equals(child.parent, this)) {
          ...
          if (!(parent !== null)) dart.assertFailed(dart.str(target) + " must be a descendant of " + dart.str(this), I[3], 759, 14, "parent != null");
        ...
        if (pivot != null) {
          if (!(pivot.parent != null)) dart.assertFailed(null, I[3], 781, 14, "pivot.parent != null");
          if (!!dart.equals(pivot.parent, this)) dart.assertFailed(null, I[3], 782, 14, "pivot.parent != this");
          if (!!dart.equals(pivot, this)) dart.assertFailed(null, I[3], 783, 14, "pivot != this");
          if (!sliver$.RenderSliver.is(pivot.parent)) dart.assertFailed(null, I[3], 784, 14, "pivot.parent is RenderSliver");
          ...
          if (!(rect != null)) dart.assertFailed(null, I[3], 825, 14, "rect != null");
          return new viewport.RevealedOffset.new({offset: this.offset.pixels, rect: dart.nullCheck(rect)});
        }
        if (!(pivotExtent !== null)) dart.assertFailed(null, I[3], 829, 12, "pivotExtent != null");
        if (!(rect != null)) dart.assertFailed(null, I[3], 830, 12, "rect != null");
        if (!(rectLocal != null)) dart.assertFailed(null, I[3], 831, 12, "rectLocal != null");
        if (!(growthDirection !== null)) dart.assertFailed(null, I[3], 832, 12, "growthDirection != null");
        if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[3], 833, 12, "child.parent == this");
        if (!sliver$.RenderSliver.is(child)) dart.assertFailed(null, I[3], 834, 12, "child is RenderSliver");
      ...
      computeAbsolutePaintOffset(child, layoutOffset, growthDirection) {
        if (!this.hasSize) dart.assertFailed(null, I[3], 942, 12, "hasSize");
        if (!(this.axisDirection !== null)) dart.assertFailed(null, I[3], 943, 12, "axisDirection != null");
        if (!(growthDirection !== null)) dart.assertFailed(null, I[3], 944, 12, "growthDirection != null");
        if (!(child !== null)) dart.assertFailed(null, I[3], 945, 12, "child != null");
        if (!(child.geometry != null)) dart.assertFailed(null, I[3], 946, 12, "child.geometry != null");
        switch (sliver$.applyGrowthDirectionToAxisDirection(this.axisDirection, growthDirection)) {
          case C[5] || CT.C5:
          {
      ...
      static showInViewport(opts) {
        ...
        let duration = opts && 'duration' in opts ? opts.duration : C[16] || CT.C16;
        let curve = opts && 'curve' in opts ? opts.curve : C[17] || CT.C17;
        if (!(viewport !== null)) dart.assertFailed(null, I[3], 1160, 12, "viewport != null");
        if (!(offset !== null)) dart.assertFailed(null, I[3], 1161, 12, "offset != null");
        if (descendant == null) {
          return rect;
        }
        ...
        if (!(targetOffset !== null)) dart.assertFailed(null, I[3], 1212, 12, "targetOffset != null");
  ...
  viewport.RenderViewport = class RenderViewport extends viewport.RenderViewportBase$(sliver$.SliverPhysicalContainerParentData) {
    ...
    set anchor(value) {
      if (!(value !== null)) dart.assertFailed(null, I[3], 1338, 12, "value != null");
      if (!(value >= 0.0 && value <= 1.0)) dart.assertFailed(null, I[3], 1339, 12, "value >= 0.0 && value <= 1.0");
    ...
    performLayout() {
      ...
      if (this.center == null) {
        if (!(this.firstChild == null)) dart.assertFailed(null, I[3], 1461, 14, "firstChild == null");
      ...
      if (!dart.equals(dart.nullCheck(this.center).parent, this)) dart.assertFailed(null, I[3], 1468, 12, "center!.parent == this");
      let mainAxisExtent = null;
      ...
      let count = 0;
      do {
        if (!(this.offset.pixels !== null)) dart.assertFailed(null, I[3], 1488, 14, "offset.pixels != null");
      ...
      if (!dart.fn(() => {
        if (count >= 10) {
          if (!(count !== 1)) dart.assertFailed(null, I[3], 1503, 16, "count != 1");
        ...
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[3], 1501, 12, "() {\n      if (count >= _maxLayoutCycles) {\n        assert(count != 1);\n        throw FlutterError(\n          'A RenderViewport exceeded its maximum number of layout cycles.\\n'\n          'RenderViewport render objects, during layout, can retry if either their '\n          'slivers or their ViewportOffset decide that the offset should be corrected '\n          'to take into account information collected during that layout.\\n'\n          'In the case of this RenderViewport object, however, this happened $count '\n          'times and still there was no consensus on the scroll offset. This usually '\n          'indicates a bug. Specifically, it means that one of the following three '\n          'problems is being experienced by the RenderViewport object:\\n'\n          ' * One of the RenderSliver children or the ViewportOffset have a bug such'\n          ' that they always think that they need to correct the offset regardless.\\n'\n          ' * Some combination of the RenderSliver children and the ViewportOffset'\n          ' have a bad interaction such that one applies a correction then another'\n          ' applies a reverse correction, leading to an infinite loop of corrections.\\n'\n          ' * There is a pathological case that would eventually resolve, but it is'\n          ' so complicated that it cannot be resolved in any reasonable number of'\n          ' layout passes.',\n        );\n      }\n      return true;\n    }()");
    }
    [_attemptLayout](mainAxisExtent, crossAxisExtent, correctedOffset) {
      if (!!mainAxisExtent[$isNaN]) dart.assertFailed(null, I[3], 1528, 12, "!mainAxisExtent.isNaN");
      if (!(mainAxisExtent >= 0.0)) dart.assertFailed(null, I[3], 1529, 12, "mainAxisExtent >= 0.0");
      if (!crossAxisExtent[$isFinite]) dart.assertFailed(null, I[3], 1530, 12, "crossAxisExtent.isFinite");
      if (!(crossAxisExtent >= 0.0)) dart.assertFailed(null, I[3], 1531, 12, "crossAxisExtent >= 0.0");
      if (!correctedOffset[$isFinite]) dart.assertFailed(null, I[3], 1532, 12, "correctedOffset.isFinite");
      this[_minScrollExtent] = 0.0;
      this[_maxScrollExtent] = 0.0;
      this[_hasVisualOverflow] = false;
    ...
    scrollOffsetOf(child, scrollOffsetWithinChild) {
      if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[3], 1626, 12, "child.parent == this");
      let growthDirection = child.constraints.growthDirection;
      if (!(growthDirection !== null)) dart.assertFailed(null, I[3], 1628, 12, "growthDirection != null");
      switch (growthDirection) {
        case C[0] || CT.C0:
        {
    ...
    maxScrollObstructionExtentBefore(child) {
      if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[3], 1651, 12, "child.parent == this");
      let growthDirection = child.constraints.growthDirection;
      if (!(growthDirection !== null)) dart.assertFailed(null, I[3], 1653, 12, "growthDirection != null");
      switch (growthDirection) {
        case C[0] || CT.C0:
        {
    ...
    applyPaintTransform(child, transform) {
      object.RenderObject.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[3], 1677, 12, "child != null");
      let childParentData = sliver$.SliverPhysicalParentData.as(dart.nullCheck(child.parentData));
      childParentData.applyPaintTransform(transform);
    }
    computeChildMainAxisPosition(child, parentMainAxisPosition) {
      if (!(child !== null)) dart.assertFailed(null, I[3], 1684, 12, "child != null");
      if (!(child.constraints !== null)) dart.assertFailed(null, I[3], 1685, 12, "child.constraints != null");
      let childParentData = sliver$.SliverPhysicalParentData.as(dart.nullCheck(child.parentData));
    ...
    get indexOfFirstChild() {
      if (!(this.center != null)) dart.assertFailed(null, I[3], 1701, 12, "center != null");
      if (!dart.equals(dart.nullCheck(this.center).parent, this)) dart.assertFailed(null, I[3], 1702, 12, "center!.parent == this");
      if (!(this.firstChild != null)) dart.assertFailed(null, I[3], 1703, 12, "firstChild != null");
      let count = 0;
    ...
    get childrenInPaintOrder() {
      ...
      while (true) {
        children[$add](dart.nullCheck(child));
        if (dart.equals(child, this.center)) return children;
  ...
  (viewport.RenderViewport.new = function(opts) {
    ...
    this[_hasVisualOverflow] = false;
    if (!(anchor !== null)) dart.assertFailed(null, I[3], 1268, 15, "anchor != null");
    if (!(anchor >= 0.0 && anchor <= 1.0)) dart.assertFailed(null, I[3], 1269, 15, "anchor >= 0.0 && anchor <= 1.0");
    if (!(cacheExtentStyle !== viewport.CacheExtentStyle.viewport || cacheExtent != null)) dart.assertFailed(null, I[3], 1270, 15, "cacheExtentStyle != CacheExtentStyle.viewport || cacheExtent != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[3], 1271, 15, "clipBehavior != null");
    this[_anchor] = anchor;
    this[_center] = center;
  ...
  viewport.RenderShrinkWrappingViewport = class RenderShrinkWrappingViewport extends viewport.RenderViewportBase$(sliver$.SliverLogicalContainerParentData) {
    ...
    performLayout() {
      ...
      if (this.firstChild == null) {
        switch (this.axis) {
          case C[8] || CT.C8:
          {
            if (!constraints.hasBoundedWidth) dart.assertFailed(null, I[3], 1849, 18, "constraints.hasBoundedWidth");
            this.size = new ui.Size.new(constraints.maxWidth, constraints.minHeight);
            break;
          }
          case C[7] || CT.C7:
          {
            if (!constraints.hasBoundedHeight) dart.assertFailed(null, I[3], 1853, 18, "constraints.hasBoundedHeight");
      ...
      switch (this.axis) {
        case C[8] || CT.C8:
        {
          if (!constraints.hasBoundedWidth) dart.assertFailed(null, I[3], 1869, 16, "constraints.hasBoundedWidth");
        ...
        case C[7] || CT.C7:
        {
          if (!constraints.hasBoundedHeight) dart.assertFailed(null, I[3], 1874, 16, "constraints.hasBoundedHeight");
      ...
      do {
        if (!(this.offset.pixels !== null)) dart.assertFailed(null, I[3], 1883, 14, "offset.pixels != null");
    ...
    [_attemptLayout](mainAxisExtent, crossAxisExtent, correctedOffset) {
      if (!!mainAxisExtent[$isNaN]) dart.assertFailed(null, I[3], 1918, 12, "!mainAxisExtent.isNaN");
      if (!(mainAxisExtent >= 0.0)) dart.assertFailed(null, I[3], 1919, 12, "mainAxisExtent >= 0.0");
      if (!crossAxisExtent[$isFinite]) dart.assertFailed(null, I[3], 1920, 12, "crossAxisExtent.isFinite");
      if (!(crossAxisExtent >= 0.0)) dart.assertFailed(null, I[3], 1921, 12, "crossAxisExtent >= 0.0");
      if (!correctedOffset[$isFinite]) dart.assertFailed(null, I[3], 1922, 12, "correctedOffset.isFinite");
      this[_maxScrollExtent] = 0.0;
      this[_shrinkWrapExtent] = 0.0;
    ...
    updateOutOfBandData(growthDirection, childLayoutGeometry) {
      if (!(growthDirection === sliver$.GrowthDirection.forward)) dart.assertFailed(null, I[3], 1958, 12, "growthDirection == GrowthDirection.forward");
      this[_maxScrollExtent] = this[_maxScrollExtent] + childLayoutGeometry.scrollExtent;
      if (childLayoutGeometry.hasVisualOverflow) this[_hasVisualOverflow] = true;
      this[_shrinkWrapExtent] = this[_shrinkWrapExtent] + childLayoutGeometry.maxPaintExtent;
    }
    updateChildLayoutOffset(child, layoutOffset, growthDirection) {
      if (!(growthDirection === sliver$.GrowthDirection.forward)) dart.assertFailed(null, I[3], 1967, 12, "growthDirection == GrowthDirection.forward");
    ...
    scrollOffsetOf(child, scrollOffsetWithinChild) {
      if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[3], 1980, 12, "child.parent == this");
      if (!(child.constraints.growthDirection === sliver$.GrowthDirection.forward)) dart.assertFailed(null, I[3], 1981, 12, "child.constraints.growthDirection == GrowthDirection.forward");
      let scrollOffsetToChild = 0.0;
    ...
    maxScrollObstructionExtentBefore(child) {
      if (!dart.equals(child.parent, this)) dart.assertFailed(null, I[3], 1993, 12, "child.parent == this");
      if (!(child.constraints.growthDirection === sliver$.GrowthDirection.forward)) dart.assertFailed(null, I[3], 1994, 12, "child.constraints.growthDirection == GrowthDirection.forward");
      let pinnedExtent = 0.0;
      let current = this.firstChild;
      while (!dart.equals(current, child)) {
        pinnedExtent = pinnedExtent + dart.nullCheck(dart.nullCheck(current).geometry).maxScrollObstructionExtent;
    ...
    applyPaintTransform(child, transform) {
      object.RenderObject.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[3], 2007, 12, "child != null");
      let offset = this.paintOffsetOf(sliver$.RenderSliver.as(child));
      transform.translate(offset.dx, offset.dy);
    }
    computeChildMainAxisPosition(child, parentMainAxisPosition) {
      if (!(child !== null)) dart.assertFailed(null, I[3], 2014, 12, "child != null");
      if (!(child.constraints !== null)) dart.assertFailed(null, I[3], 2015, 12, "child.constraints != null");
      if (!this.hasSize) dart.assertFailed(null, I[3], 2016, 12, "hasSize");
      let childParentData = sliver$.SliverLogicalParentData.as(dart.nullCheck(child.parentData));
      switch (sliver$.applyGrowthDirectionToAxisDirection(child.constraints.axisDirection, child.constraints.growthDirection)) {
        case C[3] || CT.C3:
        case C[4] || CT.C4:
