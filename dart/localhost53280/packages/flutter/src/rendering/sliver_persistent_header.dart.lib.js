define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/painting/matrix_utils.dart', 'packages/flutter/src/animation/animation_controller.dart', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/rendering/viewport_offset.dart', 'packages/flutter/src/scheduler/ticker.dart'], (function load__packages__flutter__src__rendering__sliver_persistent_header_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__painting__matrix_utils$46dart, packages__flutter__src__animation__animation_controller$46dart, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__rendering__viewport_offset$46dart, packages__flutter__src__scheduler__ticker$46dart) {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/rendering/sliver_persistent_header.dart",
  ...
  (sliver_persistent_header.OverScrollHeaderStretchConfiguration.new = function(opts) {
    ...
    if (!(stretchTriggerOffset !== null)) dart.assertFailed(null, I[0], 41, 15, "stretchTriggerOffset != null");
    ;
  ...
  (sliver_persistent_header.PersistentHeaderShowOnScreenConfiguration.new = function(opts) {
    ...
    if (!(minShowOnScreenExtent <= maxShowOnScreenExtent)) dart.assertFailed(null, I[0], 62, 15, "minShowOnScreenExtent <= maxShowOnScreenExtent");
    ;
  ...
  sliver_persistent_header.RenderSliverPersistentHeader = class RenderSliverPersistentHeader extends RenderSliver_RenderSliverHelpers$36 {
    ...
    hitTestChildren(result, opts) {
      ...
      if (!(dart.nullCheck(this.geometry).hitTestExtent > 0.0)) dart.assertFailed(null, I[0], 287, 12, "geometry!.hitTestExtent > 0.0");
    ...
    applyPaintTransform(child, transform) {
      object.RenderObject.as(child);
      if (!(child !== null)) dart.assertFailed(null, I[0], 295, 12, "child != null");
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 296, 12, "child == this.child");
    ...
    paint(context, offset) {
      if (this.child != null && dart.nullCheck(this.geometry).visible) {
        if (!(this.constraints.axisDirection !== null)) dart.assertFailed(null, I[0], 303, 14, "constraints.axisDirection != null");
  ...
  sliver_persistent_header.RenderSliverScrollingPersistentHeader = class RenderSliverScrollingPersistentHeader extends sliver_persistent_header.RenderSliverPersistentHeader {
    ...
    childMainAxisPosition(child) {
      ...
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 396, 12, "child == this.child");
      if (!(this[_childPosition] != null)) dart.assertFailed(null, I[0], 397, 12, "_childPosition != null");
  ...
  (sliver_persistent_header.FloatingHeaderSnapConfiguration.new = function(opts) {
    ...
    if (!(curve !== null)) dart.assertFailed(null, I[0], 503, 15, "curve != null");
    if (!(duration !== null)) dart.assertFailed(null, I[0], 504, 15, "duration != null");
    ;
  ...
  sliver_persistent_header.RenderSliverFloatingPersistentHeader = class RenderSliverFloatingPersistentHeader extends sliver_persistent_header.RenderSliverPersistentHeader {
    ...
    [_updateAnimation](duration, endValue, curve) {
      let t3, t2;
      if (!(duration !== null)) dart.assertFailed(null, I[0], 617, 12, "duration != null");
      if (!(endValue !== null)) dart.assertFailed(null, I[0], 618, 12, "endValue != null");
      if (!(curve !== null)) dart.assertFailed(null, I[0], 619, 12, "curve != null");
      if (!(this.vsync != null)) dart.assertFailed("vsync must not be null if the floating header changes size animatedly.", I[0], 621, 7, "vsync != null");
    ...
    showOnScreen(opts) {
      ...
      if (!(this.child != null || descendant == null)) dart.assertFailed(null, I[0], 716, 12, "child != null || descendant == null");
      ...
      if (dart.notNull(targetExtent) > this.childExtent) {
        ...
        if (!(this.vsync != null)) dart.assertFailed("vsync must not be null if the floating header changes size animatedly.", I[0], 763, 9, "vsync != null");
    ...
    childMainAxisPosition(child) {
      let t2;
      box.RenderBox.as(child);
      if (!child[$_equals](this.child)) dart.assertFailed(null, I[0], 780, 12, "child == this.child");
