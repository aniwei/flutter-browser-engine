define(['dart_sdk', 'packages/flutter/src/gestures/velocity_tracker.dart', 'packages/flutter/src/gestures/constants.dart', 'packages/flutter/src/gestures/arena.dart', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/gestures/recognizer.dart'], (function load__packages__flutter__src__gestures__long_press_dart(dart_sdk, packages__flutter__src__gestures__velocity_tracker$46dart, packages__flutter__src__gestures__constants$46dart, packages__flutter__src__gestures__arena$46dart, packages__flutter__src__gestures__events$46dart, packages__flutter__src__gestures__recognizer$46dart) {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/gestures/long_press.dart",
  ...
  (long_press.LongPressDownDetails.new = function(opts) {
    ...
    this[kind$] = kind;
    if (!(globalPosition !== null)) dart.assertFailed(null, I[0], 114, 15, "globalPosition != null");
  ...
  (long_press.LongPressStartDetails.new = function(opts) {
    ...
    if (!(globalPosition !== null)) dart.assertFailed(null, I[0], 141, 15, "globalPosition != null");
  ...
  (long_press.LongPressMoveUpdateDetails.new = function(opts) {
    ...
    if (!(globalPosition !== null)) dart.assertFailed(null, I[0], 167, 15, "globalPosition != null");
    if (!(offsetFromOrigin !== null)) dart.assertFailed(null, I[0], 168, 15, "offsetFromOrigin != null");
  ...
  (long_press.LongPressEndDetails.new = function(opts) {
    ...
    if (!(globalPosition !== null)) dart.assertFailed(null, I[0], 204, 15, "globalPosition != null");
  ...
  long_press.LongPressGestureRecognizer = class LongPressGestureRecognizer extends recognizer.PrimaryPointerGestureRecognizer {
    ...
    isPointerAllowed(event) {
      switch (event.buttons) {
        case 1:
        {
          if (this.onLongPressDown == null && this.onLongPressCancel == null && this.onLongPressStart == null && this.onLongPress == null && this.onLongPressMoveUpdate == null && this.onLongPressEnd == null && this.onLongPressUp == null) return false;
          break;
        }
        case 2:
        {
          if (this.onSecondaryLongPressDown == null && this.onSecondaryLongPressCancel == null && this.onSecondaryLongPressStart == null && this.onSecondaryLongPress == null && this.onSecondaryLongPressMoveUpdate == null && this.onSecondaryLongPressEnd == null && this.onSecondaryLongPressUp == null) return false;
          break;
        }
        case 4:
        {
          if (this.onTertiaryLongPressDown == null && this.onTertiaryLongPressCancel == null && this.onTertiaryLongPressStart == null && this.onTertiaryLongPress == null && this.onTertiaryLongPressMoveUpdate == null && this.onTertiaryLongPressEnd == null && this.onTertiaryLongPressUp == null) return false;
          break;
        }
        default:
        {
    ...
    handlePrimaryPointer(event) {
      if (!event.synthesized) {
        ...
        if (events.PointerMoveEvent.is(event)) {
          if (!(this[_velocityTracker] != null)) dart.assertFailed(null, I[0], 626, 16, "_velocityTracker != null");
          dart.nullCheck(this[_velocityTracker]).addPosition(event.timeStamp, event.localPosition);
        }
      }
    ...
    [_checkLongPressDown](event) {
      if (!(this[_longPressOrigin] != null)) dart.assertFailed(null, I[0], 658, 12, "_longPressOrigin != null");
      ...
      switch (this[_initialButtons]) {
        case 1:
        {
          if (this.onLongPressDown != null) this.invokeCallback(dart.void, "onLongPressDown", dart.fn(() => dart.nullCheck(this.onLongPressDown)(details), T.VoidTovoid()));
          break;
        }
        case 2:
        {
          if (this.onSecondaryLongPressDown != null) this.invokeCallback(dart.void, "onSecondaryLongPressDown", dart.fn(() => dart.nullCheck(this.onSecondaryLongPressDown)(details), T.VoidTovoid()));
          break;
        }
        case 4:
        {
          if (this.onTertiaryLongPressDown != null) this.invokeCallback(dart.void, "onTertiaryLongPressDown", dart.fn(() => dart.nullCheck(this.onTertiaryLongPressDown)(details), T.VoidTovoid()));
          break;
        }
        default:
        {
          if (!false) dart.assertFailed("Unhandled button " + dart.str(this[_initialButtons]), I[0], 678, 16, "false");
        }
      }
    }
    [_checkLongPressCancel]() {
      if (this.state === recognizer.GestureRecognizerState.possible) {
        switch (this[_initialButtons]) {
          case 1:
          {
            if (this.onLongPressCancel != null) this.invokeCallback(dart.void, "onLongPressCancel", dart.nullCheck(this.onLongPressCancel));
            break;
          }
          case 2:
          {
            if (this.onSecondaryLongPressCancel != null) this.invokeCallback(dart.void, "onSecondaryLongPressCancel", dart.nullCheck(this.onSecondaryLongPressCancel));
            break;
          }
          case 4:
          {
            if (this.onTertiaryLongPressCancel != null) this.invokeCallback(dart.void, "onTertiaryLongPressCancel", dart.nullCheck(this.onTertiaryLongPressCancel));
            break;
          }
          default:
          {
            if (!false) dart.assertFailed("Unhandled button " + dart.str(this[_initialButtons]), I[0], 698, 18, "false");
          }
        }
      }
    }
    [_checkLongPressStart]() {
      switch (this[_initialButtons]) {
        ...
        default:
        {
          if (!false) dart.assertFailed("Unhandled button " + dart.str(this[_initialButtons]), I[0], 742, 16, "false");
        }
      }
    }
    [_checkLongPressMoveUpdate](event) {
      ...
      switch (this[_initialButtons]) {
        ...
        default:
        {
          if (!false) dart.assertFailed("Unhandled button " + dart.str(this[_initialButtons]), I[0], 770, 16, "false");
        }
      }
    }
    [_checkLongPressEnd](event) {
      ...
      switch (this[_initialButtons]) {
        ...
        default:
        {
          if (!false) dart.assertFailed("Unhandled button " + dart.str(this[_initialButtons]), I[0], 812, 16, "false");
        }
      }
    }
    [_reset]() {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["long_press.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAqHe;;;;;;IAGY;;;;;;IAGZ;;;;;;;;;;;;;;;QAbN;QACG;QACH;IAFA;IAEA;UACK,AAAe,cAAD;IACP,wBAAgB,KAAd,aAAa,EAAb,aAAiB,cAAc;;;;;;;;;;;;;;;IA8BvC;;;;;;IAGA;;;;;;;;;;;;;;QATN;QACG;IADH;UAEK,AAAe,cAAD;IACP,yBAAgB,KAAd,aAAa,