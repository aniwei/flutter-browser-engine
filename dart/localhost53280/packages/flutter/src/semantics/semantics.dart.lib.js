define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/collections.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/matrix_utils.dart', 'packages/flutter/src/services/text_editing.dart', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/services/restoration.dart', 'packages/flutter/src/foundation/node.dart', 'packages/flutter/src/semantics/semantics_event.dart', 'packages/flutter/src/foundation/key.dart', 'packages/flutter/src/semantics/binding.dart', 'packages/flutter/src/foundation/change_notifier.dart'], (function load__packages__flutter__src__semantics__semantics_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__collections$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__matrix_utils$46dart, packages__flutter__src__services__text_editing$46dart, packages__vector_math__vector_math_64$46dart, packages__flutter__src__services__restoration$46dart, packages__flutter__src__foundation__node$46dart, packages__flutter__src__semantics__semantics_event$46dart, packages__flutter__src__foundation__key$46dart, packages__flutter__src__semantics__binding$46dart, packages__flutter__src__foundation__change_notifier$46dart) {
  'use strict';
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/semantics/semantics.dart"
  ];
  ...
  (semantics.CustomSemanticsAction.new = function(opts) {
    let label = opts && 'label' in opts ? opts.label : null;
    this[label$] = label;
    if (!(label !== null)) dart.assertFailed(null, I[1], 108, 14, "label != null");
    if (!(label !== "")) dart.assertFailed(null, I[1], 109, 14, "label != ''");
    this[hint$] = null;
    this[action$] = null;
    ;
  ...
  (semantics.CustomSemanticsAction.overridingAction = function(opts) {
    ...
    this[hint$] = hint;
    this[action$] = action;
    if (!(hint !== null)) dart.assertFailed(null, I[1], 118, 14, "hint != null");
    if (!(hint !== "")) dart.assertFailed(null, I[1], 119, 14, "hint != ''");
    if (!(action !== null)) dart.assertFailed(null, I[1], 120, 14, "action != null");
    this[label$] = null;
    ;
  }).prototype = semantics.CustomSemanticsAction.prototype;
  ...
  semantics.AttributedString = class AttributedString extends core.Object {
    ...
    get hashCode() {
      return ui.hashValues(this.string, this.attributes);
    }
    toString() {
  ...
  (semantics.AttributedString.new = function(string, opts) {
    ...
    if (!(string[$isNotEmpty] || attributes[$isEmpty])) dart.assertFailed(null, I[1], 186, 15, "string.isNotEmpty || attributes.isEmpty");
    if (!dart.fn(() => {
      for (let attribute of attributes) {
        if (!(string.length >= attribute.range.start && string.length >= attribute.range.end)) dart.assertFailed("The range in " + dart.str(attribute) + " is outside of the string " + string, I[1], 190, 13, "string.length >= attribute.range.start &&\n            string.length >= attribute.range.end");
      }
      return true;
    }, T.VoidTobool())()) dart.assertFailed(null, I[1], 187, 15, "() {\n        for (final StringAttribute attribute in attributes) {\n          assert(\n            string.length >= attribute.range.start &&\n            string.length >= attribute.range.end,\n            'The range in $attribute is outside of the string $string',\n          );\n        }\n        return true;\n      }()");
    ;
  ...
  (semantics.SemanticsData.new = function(opts) {
    ...
    if (!(flags !== null)) dart.assertFailed(null, I[1], 348, 15, "flags != null");
    if (!(actions !== null)) dart.assertFailed(null, I[1], 349, 15, "actions != null");
    if (!(attributedLabel !== null)) dart.assertFailed(null, I[1], 350, 15, "attributedLabel != null");
    if (!(attributedValue !== null)) dart.assertFailed(null, I[1], 351, 15, "attributedValue != null");
    if (!(attributedDecreasedValue !== null)) dart.assertFailed(null, I[1], 352, 15, "attributedDecreasedValue != null");
    if (!(attributedIncreasedValue !== null)) dart.assertFailed(null, I[1], 353, 15, "attributedIncreasedValue != null");
    if (!(attributedHint !== null)) dart.assertFailed(null, I[1], 354, 15, "attributedHint != null");
    if (!(attributedLabel.string === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with label \"" + attributedLabel.string + "\" had a null textDirection.", I[1], 355, 15, "attributedLabel.string == '' || textDirection != null");
    if (!(attributedValue.string === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with value \"" + attributedValue.string + "\" had a null textDirection.", I[1], 356, 15, "attributedValue.string == '' || textDirection != null");
    if (!(attributedDecreasedValue.string === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with decreasedValue \"" + attributedDecreasedValue.string + "\" had a null textDirection.", I[1], 357, 15, "attributedDecreasedValue.string == '' || textDirection != null");
    if (!(attributedIncreasedValue.string === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with increasedValue \"" + attributedIncreasedValue.string + "\" had a null textDirection.", I[1], 358, 15, "attributedIncreasedValue.string == '' || textDirection != null");
    if (!(attributedHint.string === "" || textDirection != null)) dart.assertFailed("A SemanticsData object with hint \"" + attributedHint.string + "\" had a null textDirection.", I[1], 359, 15, "attributedHint.string == '' || textDirection != null");
    if (!(rect !== null)) dart.assertFailed(null, I[1], 360, 15, "rect != null");
    ;
  ...
  semantics.SemanticsNode = class SemanticsNode extends AbstractNode_DiagnosticableTreeMixin$36 {
    ...
    set rect(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 1591, 12, "value != null");
      if (!value.isFinite) dart.assertFailed(dart.str(this) + " (with " + dart.str(this.owner) + ") tried to set a non-finite rect.", I[1], 1592, 12, "value.isFinite");
    ...
    set isMergedIntoParent(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 1676, 12, "value != null");
    ...
    [_replaceChildren](newChildren) {
      let t4;
      if (!!newChildren[$any](dart.fn(child => child[$_equals](this), T.SemanticsNodeTobool()))) dart.assertFailed(null, I[1], 1710, 12, "!newChildren.any((SemanticsNode child) => child == this)");
      if (!dart.fn(() => {
        ...
        if (!(!newChildren[$any](dart.fn(node => node.isMergedIntoParent, T.SemanticsNodeTobool())) || this.isPartOfNodeMerging)) dart.assertFailed(null, I[1], 1740, 14, "!newChildren.any((SemanticsNode node) => node.isMergedIntoParent) || isPartOfNodeMerging");
      ...
      for (let child of newChildren) {
        if (!dart.equals(child.parent, this)) {
          ...
          if (!!child.attached) dart.assertFailed(null, I[1], 1789, 16, "!child.attached");
          this.adoptChild(child);
          sawChange = true;
        }
      }
      if (!sawChange && this[_children] != null) {
        if (!(newChildren !== null)) dart.assertFailed(null, I[1], 1795, 14, "newChildren != null");
        if (!(newChildren[$length] === dart.nullCheck(this[_children])[$length])) dart.assertFailed(null, I[1], 1796, 14, "newChildren.length == _children!.length");
    ...
    detach() {
      if (!dart.nullCheck(this.owner)[_nodes][$containsKey](this.id)) dart.assertFailed(null, I[1], 1881, 12, "owner!._nodes.containsKey(id)");
      if (!!dart.nullCheck(this.owner)[_detachedNodes].contains(this)) dart.assertFailed(null, I[1], 1882, 12, "!owner!._detachedNodes.contains(this)");
      dart.nullCheck(this.owner)[_nodes][$remove](this.id);
      dart.nullCheck(this.owner)[_detachedNodes].add(this);
      super.detach();
      if (!(this.owner == null)) dart.assertFailed(null, I[1], 1886, 12, "owner == null");
      if (this[_children] != null) {
        for (let child of dart.nullCheck(this[_children])) {
    ...
    [_markDirty]() {
      ...
      this[_dirty] = true;
      if (this.attached) {
        if (!!dart.nullCheck(this.owner)[_detachedNodes].contains(this)) dart.assertFailed(null, I[1], 1909, 14, "!owner!._detachedNodes.contains(this)");
        dart.nullCheck(this.owner)[_dirtyNodes].add(this);
      }
    }
    [_isDifferentFromCurrentSemanticAnnotation](config) {
      return !this[_attributedLabel]._equals(config.attributedLabel) || !this[_attributedHint]._equals(config.attributedHint) || this[_elevation] !== config.elevation || this[_thickness] !== config.thickness || !this[_attributedValue]._equals(config.attributedValue) || !this[_attributedIncreasedValue]._equals(config.attributedIncreasedValue) || !this[_attributedDecreasedValue]._equals(config.attributedDecreasedValue) || this[_flags] !== config[_flags] || this[_textDirection] != config.textDirection || !dart.equals(this[_sortKey], config[_sortKey]) || !dart.equals(this[_textSelection], config[_textSelection]) || this[_scrollPosition] != config[_scrollPosition] || this[_scrollExtentMax] != config[_scrollExtentMax] || this[_scrollExtentMin] != config[_scrollExtentMin] || this[_actionsAsBits] !== config[_actionsAsBits] || this.indexInParent != config.indexInParent || this.platformViewId != config.platformViewId || this[_maxValueLength] != config[_maxValueLength] || this[_currentValueLength] != config[_currentValueLength] || this[_mergeAllDescendantsIntoThisNode] !== config.isMergingSemanticsOfDescendants;
    }
    isTagged(tag) {
    ...
    updateWith(opts) {
      ...
      if (!(config.platformViewId == null || childrenInInversePaintOrder == null || childrenInInversePaintOrder[$isEmpty])) dart.assertFailed("SemanticsNodes with children must not specify a platformViewId.", I[1], 2250, 7, "config.platformViewId == null || childrenInInversePaintOrder == null || childrenInInversePaintOrder.isEmpty");
      ...
      this[_replaceChildren]((t4 = childrenInInversePaintOrder, t4 == null ? C[3] || CT.C3 : t4));
      if (!(!this[_canPerformAction](ui.SemanticsAction.increase) || this.value === "" === (this.increasedValue === ""))) dart.assertFailed("A SemanticsNode with action \"increase\" needs to be annotated with either both \"value\" and \"increasedValue\" or neither", I[1], 2283, 7, "!_canPerformAction(SemanticsAction.increase) || (value == '') == (increasedValue == '')");
      if (!(!this[_canPerformAction](ui.SemanticsAction.decrease) || this.value === "" === (this.decreasedValue === ""))) dart.assertFailed("A SemanticsNode with action \"increase\" needs to be annotated with either both \"value\" and \"decreasedValue\" or neither", I[1], 2287, 7, "!_canPerformAction(SemanticsAction.decrease) || (value == '') == (decreasedValue == '')");
    }
    getSemanticsData() {
      let t4;
      ...
      if (this.mergeAllDescendantsIntoThisNode) {
        this[_visitDescendants](dart.fn(node => {
          if (!node.isMergedIntoParent) dart.assertFailed(null, I[1], 2341, 16, "node.isMergedIntoParent");
          ...
          if (attributedIncreasedValue === null || attributedIncreasedValue.string === "") attributedIncreasedValue = node[_attributedIncreasedValue];
          if (attributedDecreasedValue === null || attributedDecreasedValue.string === "") attributedDecreasedValue = node[_attributedDecreasedValue];
          if (node.tags != null) {
    ...
    [_addToUpdate](builder, customSemanticsActionIdsUpdate) {
      ...
      if (!this[_dirty]) dart.assertFailed(null, I[1], 2437, 12, "_dirty");
    ...
    toStringDeep(opts) {
      ...
      if (!(childOrder !== null)) dart.assertFailed(null, I[1], 2646, 12, "childOrder != null");
    ...
    debugListChildrenInOrder(childOrder) {
      if (!(childOrder !== null)) dart.assertFailed(null, I[1], 2673, 12, "childOrder != null");
      if (this[_children] == null) return C[3] || CT.C3;
      switch (childOrder) {
        case C[7] || CT.C7:
        {
  ...
  (semantics.SemanticsHintOverrides.new = function(opts) {
    ...
    if (!(onTapHint !== "")) dart.assertFailed(null, I[1], 718, 15, "onTapHint != ''");
    if (!(onLongPressHint !== "")) dart.assertFailed(null, I[1], 719, 15, "onLongPressHint != ''");
  ...
  (semantics.SemanticsProperties.new = function(opts) {
    ...
    if (!(label == null || attributedLabel == null)) dart.assertFailed("Only one of label or attributedLabel should be provided", I[1], 833, 15, "label == null || attributedLabel == null");
    if (!(value == null || attributedValue == null)) dart.assertFailed("Only one of value or attributedValue should be provided", I[1], 834, 15, "value == null || attributedValue == null");
    if (!(increasedValue == null || attributedIncreasedValue == null)) dart.assertFailed("Only one of increasedValue or attributedIncreasedValue should be provided", I[1], 835, 15, "increasedValue == null || attributedIncreasedValue == null");
    if (!(decreasedValue == null || attributedDecreasedValue == null)) dart.assertFailed("Only one of decreasedValue or attributedDecreasedValue should be provided", I[1], 836, 15, "decreasedValue == null || attributedDecreasedValue == null");
    if (!(hint == null || attributedHint == null)) dart.assertFailed("Only one of hint or attributedHint should be provided", I[1], 837, 15, "hint == null || attributedHint == null");
  ...
  (semantics._BoxEdge.new = function(opts) {
    ...
    this.offset = offset;
    this.node = node;
    if (!(isLeadingEdge !== null)) dart.assertFailed(null, I[1], 2699, 15, "isLeadingEdge != null");
    if (!(offset !== null)) dart.assertFailed(null, I[1], 2700, 15, "offset != null");
    if (!offset[$isFinite]) dart.assertFailed(null, I[1], 2701, 15, "offset.isFinite");
    if (!(node !== null)) dart.assertFailed(null, I[1], 2702, 15, "node != null");
    ;
  ...
  (semantics._SemanticsSortGroup.new = function(opts) {
    ...
    this.textDirection = textDirection;
    if (!(startOffset !== null)) dart.assertFailed(null, I[1], 2736, 15, "startOffset != null");
    ;
  ...
  (semantics._TraversalSortNode.new = function(opts) {
    ...
    if (!(node !== null)) dart.assertFailed(null, I[1], 2960, 14, "node != null");
    if (!(position !== null)) dart.assertFailed(null, I[1], 2961, 14, "position != null");
    ;
  ...
  semantics.SemanticsOwner = class SemanticsOwner extends change_notifier.ChangeNotifier {
    ...
    sendSemanticsUpdate() {
      ...
      while (this[_dirtyNodes][$isNotEmpty]) {
        ...
        for (let node of localDirtyNodes) {
          if (!node[_dirty]) dart.assertFailed(null, I[1], 3022, 16, "node._dirty");
          if (!(node.parent == null || !dart.nullCheck(node.parent).isPartOfNodeMerging || node.isMergedIntoParent)) dart.assertFailed(null, I[1], 3023, 16, "node.parent == null || !node.parent!.isPartOfNodeMerging || node.isMergedIntoParent");
          if (node.isPartOfNodeMerging) {
            if (!(node.mergeAllDescendantsIntoThisNode || node.parent != null)) dart.assertFailed(null, I[1], 3025, 18, "node.mergeAllDescendantsIntoThisNode || node.parent != null");
      ...
      for (let node of visitedNodes) {
        if (!((t4 = node.parent, t4 == null ? null : t4[_dirty]) !== true)) dart.assertFailed(null, I[1], 3037, 14, "node.parent?._dirty != true");
    ...
    performAction(id, action, args = null) {
      if (!(action !== null)) dart.assertFailed(null, I[1], 3084, 12, "action != null");
    ...
    performActionAt(position, action, args = null) {
      if (!(action !== null)) dart.assertFailed(null, I[1], 3134, 12, "action != null");
  ...
  semantics.SemanticsConfiguration = class SemanticsConfiguration extends core.Object {
    ...
    set isSemanticBoundary(value) {
      if (!(!this.isMergingSemanticsOfDescendants || value)) dart.assertFailed(null, I[1], 3172, 12, "!isMergingSemanticsOfDescendants || value");
    ...
    [_addAction](action, handler) {
      if (!(handler !== null)) dart.assertFailed(null, I[1], 3234, 12, "handler != null");
    ...
    [_addArgumentlessAction](action, handler) {
      if (!(handler !== null)) dart.assertFailed(null, I[1], 3246, 12, "handler != null");
      this[_addAction](action, dart.fn(args => {
        if (!(args == null)) dart.assertFailed(null, I[1], 3248, 14, "args == null");
        handler();
      }, T.ObjectNTovoid()));
    }
    get onTap() {
    ...
    set onMoveCursorForwardByCharacter(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3485, 12, "value != null");
    ...
    set onMoveCursorBackwardByCharacter(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3503, 12, "value != null");
    ...
    set onMoveCursorForwardByWord(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3521, 12, "value != null");
    ...
    set onMoveCursorBackwardByWord(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3539, 12, "value != null");
    ...
    set onSetSelection(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3557, 12, "value != null");
      this[_addAction](ui.SemanticsAction.setSelection, dart.fn(args => {
        if (!(args != null && core.Map.is(args))) dart.assertFailed(null, I[1], 3559, 14, "args != null && args is Map");
        let selection = core.Map.as(dart.nullCheck(args))[$cast](core.String, core.int);
        if (!(selection !== null && selection[$_get]("base") != null && selection[$_get]("extent") != null)) dart.assertFailed(null, I[1], 3561, 14, "selection != null && selection['base'] != null && selection['extent'] != null");
    ...
    set onSetText(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3580, 12, "value != null");
      this[_addAction](ui.SemanticsAction.setText, dart.fn(args => {
        if (!(args != null && typeof args == 'string')) dart.assertFailed(null, I[1], 3582, 14, "args != null && args is String");
    ...
    set sortKey(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 3655, 12, "value != null");
      this[_sortKey] = value;
      this[_hasBeenAnnotated] = true;
    }
    get indexInParent() {
    ...
    set isMergingSemanticsOfDescendants(value) {
      if (!this.isSemanticBoundary) dart.assertFailed(null, I[1], 3753, 12, "isSemanticBoundary");
    ...
    set label(label) {
      if (!(label !== null)) dart.assertFailed(null, I[1], 3793, 12, "label != null");
    ...
    set value(value) {
      if (!(value !== null)) dart.assertFailed(null, I[1], 3834, 12, "value != null");
    ...
    set increasedValue(increasedValue) {
      if (!(increasedValue !== null)) dart.assertFailed(null, I[1], 3880, 12, "increasedValue != null");
    ...
    set decreasedValue(decreasedValue) {
      if (!(decreasedValue !== null)) dart.assertFailed(null, I[1], 3918, 12, "decreasedValue != null");
    ...
    set hint(hint) {
      if (!(hint !== null)) dart.assertFailed(null, I[1], 3953, 12, "hint != null");
    ...
    set elevation(value) {
      if (!(value !== null && value >= 0.0)) dart.assertFailed(null, I[1], 3995, 12, "value != null && value >= 0.0");
    ...
    set thickness(value) {
      if (!(value !== null && value >= 0.0)) dart.assertFailed(null, I[1], 4012, 12, "value != null && value >= 0.0");
    ...
    set textSelection(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 4261, 12, "value != null");
    ...
    set scrollPosition(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 4279, 12, "value != null");
    ...
    set scrollExtentMax(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 4295, 12, "value != null");
    ...
    set scrollExtentMin(value) {
      if (!(value != null)) dart.assertFailed(null, I[1], 4311, 12, "value != null");
    ...
    isCompatibleWith(other) {
      ...
      if (this[_attributedValue] !== null && this[_attributedValue].string[$isNotEmpty] && other[_attributedValue] !== null && other[_attributedValue].string[$isNotEmpty]) return false;
      return true;
    }
    absorb(child) {
      if (!!this.explicitChildNodes) dart.assertFailed(null, I[1], 4402, 12, "!explicitChildNodes");
      ...
      if (this[_attributedValue] === null || this[_attributedValue].string === "") this[_attributedValue] = child[_attributedValue];
      if (this[_attributedIncreasedValue] === null || this[_attributedIncreasedValue].string === "") this[_attributedIncreasedValue] = child[_attributedIncreasedValue];
      if (this[_attributedDecreasedValue] === null || this[_attributedDecreasedValue].string === "") this[_attributedDecreasedValue] = child[_attributedDecreasedValue];
    ...
    copy() {
      ...
      return (() => {
        ...
        t4[_attributedLabel] = this[_attributedLabel];
        t4[_attributedIncreasedValue] = this[_attributedIncreasedValue];
        t4[_attributedValue] = this[_attributedValue];
        t4[_attributedDecreasedValue] = this[_attributedDecreasedValue];
        t4[_attributedHint] = this[_attributedHint];
  ...
  semantics.DebugSemanticsDumpOrder.inverseHitTest = C[7] || CT.C7;
  semantics.DebugSemanticsDumpOrder.traversalOrder = C[5] || CT.C5;
  semantics.DebugSemanticsDumpOrder.values = C[8] || CT.C8;
  ...
  semantics.SemanticsSortKey = class SemanticsSortKey extends Object_Diagnosticable$36$ {
    ...
    compareTo(other) {
      ...
      if (!this[$runtimeType]._equals(other[$runtimeType])) dart.assertFailed("Semantics sort keys can only be compared to other sort keys of the same type.", I[1], 4559, 12, "runtimeType == other.runtimeType");
  ...
  (semantics.OrdinalSortKey.new = function(order, opts) {
    let name = opts && 'name' in opts ? opts.name : null;
    this[order$] = order;
    if (!(order !== null)) dart.assertFailed(null, I[1], 4622, 15, "order != null");
    if (!(order !== 0 / 0)) dart.assertFailed(null, I[1], 4623, 15, "order != double.nan");
    if (!(order > -1 / 0)) dart.assertFailed(null, I[1], 4624, 15, "order > double.negativeInfinity");
    if (!(order < 1 / 0)) dart.assertFailed(null, I[1], 4625, 15, "order < double.infinity");
  ...
  semantics._childrenInDefaultOrder = function _childrenInDefaultOrder(children, textDirection) {
    ...
    for (let child of children) {
      if (!child.rect.isFinite) dart.assertFailed(null, I[1], 2905, 12, "child.rect.isFinite");
      let childRect = child.rect.deflate(0.1);
