define(['dart_sdk', 'packages/flutter/src/widgets/widget_inspector.dart', 'packages/flutter/src/animation/animation_controller.dart', 'packages/flutter/src/cupertino/text_theme.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/services/haptic_feedback.dart'], (function load__packages__flutter__src__cupertino__scrollbar_dart(dart_sdk, packages__flutter__src__widgets__widget_inspector$46dart, packages__flutter__src__animation__animation_controller$46dart, packages__flutter__src__cupertino__text_theme$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__services__haptic_feedback$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C[4] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 71,
        [_Location_file]: "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/cupertino/scrollbar.dart"
      });
    },
    get C5() {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/cupertino/scrollbar.dart",
  ...
  (scrollbar$.CupertinoScrollbar.new = function(opts) {
    ...
    if (!(thickness !== null)) dart.assertFailed(null, I[0], 82, 15, "thickness != null");
    if (!(thickness < 1 / 0)) dart.assertFailed(null, I[0], 83, 15, "thickness < double.infinity");
    if (!(thicknessWhileDragging !== null)) dart.assertFailed(null, I[0], 84, 15, "thicknessWhileDragging != null");
    if (!(thicknessWhileDragging < 1 / 0)) dart.assertFailed(null, I[0], 85, 15, "thicknessWhileDragging < double.infinity");
    if (!(radius !== null)) dart.assertFailed(null, I[0], 86, 15, "radius != null");
    if (!(radiusWhileDragging !== null)) dart.assertFailed(null, I[0], 87, 15, "radiusWhileDragging != null");
    scrollbar$.CupertinoScrollbar.__proto__.new.call(this, {key: key, child: child, controller: controller, isAlwaysShown: isAlwaysShown, thickness: thickness, radius: radius, fadeDuration: scrollbar$._kScrollbarFadeDuration, timeToFade: scrollbar$._kScrollbarTimeToFade, pressDuration: C[2] || CT.C2, notificationPredicate: (t0 = notificationPredicate, t0 == null ? C[3] || CT.C3 : t0), scrollbarOrientation: scrollbarOrientation, $creationLocationd_0dea112b090073317d4: $36creationLocationd_0dea112b090073317d4});
    ;
  ...
  scrollbar$._CupertinoScrollbarState = class _CupertinoScrollbarState extends scrollbar.RawScrollbarState$(scrollbar$.CupertinoScrollbar) {
    ...
    updateScrollbarPainter() {
      ...
      (() => {
        ...
        t1.scrollbarOrientation = this.widget.scrollbarOrientation;
        return t1;
      })();
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["scrollbar.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAwHe;;;;;;IAQA;;;;;;;;;;;;;;;;;;;;AAG0C;IAA0B;;;;QA5D1E;QACW;QACE;QACb;QACE;QACF;QACE;QACF;QACwB;QACP;;IAJjB;IAEA;UAGK,AAAU,SAAD;UACT,AAAU,SAAD;UACT,AAAuB,sBAAD;UACtB,AAAuB,sBAAD;UACtB,AAAO,MAAD;UACN,AAAoB,mBAAD;AAC1B,iEACO