define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/gestures/recognizer.dart', 'packages/flutter/src/widgets/widget_inspector.dart', 'packages/flutter/src/rendering/viewport_offset.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/foundation/key.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/widgets/sliver_prototype_extent_list.dart', 'packages/flutter/src/rendering/sliver_grid.dart'], (function load__packages__flutter__src__widgets__scroll_view_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__gestures__recognizer$46dart, packages__flutter__src__widgets__widget_inspector$46dart, packages__flutter__src__rendering__viewport_offset$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__foundation__key$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__widgets__sliver_prototype_extent_list$46dart, packages__flutter__src__rendering__sliver_grid$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C11() {
      return C[11] = dart.const({
        ...
        [_Location_column]: 14,
        [_Location_line]: 368,
        [_Location_file]: "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/scroll_view.dart"
      });
    },
    get C12() {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/scroll_view.dart"
  ];
  ...
  scroll_view.ScrollView = class ScrollView extends framework.StatelessWidget {
    ...
    build(context) {
      ...
      let scrollable = new scrollable$.Scrollable.new({dragStartBehavior: this.dragStartBehavior, axisDirection: axisDirection, controller: scrollController, physics: this.physics, scrollBehavior: this.scrollBehavior, semanticChildCount: this.semanticChildCount, restorationId: this.restorationId, viewportBuilder: dart.fn((context, offset) => this.buildViewport(context, offset, axisDirection, slivers), T.BuildContextAndViewportOffsetToWidget()), $creationLocationd_0dea112b090073317d4: C[13] || CT.C13});
      let scrollableResult = this.primary && scrollController != null ? new primary_scroll_controller.PrimaryScrollController.none({child: scrollable, $creationLocationd_0dea112b090073317d4: C[14] || CT.C14}) : scrollable;
  ...
  (scroll_view.ScrollView.new = function(opts) {
    ...
    if (!(scrollDirection !== null)) dart.assertFailed(null, I[1], 98, 15, "scrollDirection != null");
    if (!(reverse !== null)) dart.assertFailed(null, I[1], 99, 15, "reverse != null");
    if (!(shrinkWrap !== null)) dart.assertFailed(null, I[1], 100, 15, "shrinkWrap != null");
    if (!(dragStartBehavior !== null)) dart.assertFailed(null, I[1], 101, 15, "dragStartBehavior != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[1], 102, 15, "clipBehavior != null");
    if (!!(controller != null && primary === true)) dart.assertFailed("Primary ScrollViews obtain their ScrollController via inheritance from a PrimaryScrollController widget. " + "You cannot both set primary to true and pass an explicit controller.", I[1], 103, 15, "!(controller != null && primary == true)");
    if (!(!shrinkWrap || center == null)) dart.assertFailed(null, I[1], 107, 15, "!shrinkWrap || center == null");
    if (!(anchor !== null)) dart.assertFailed(null, I[1], 108, 15, "anchor != null");
    if (!(anchor >= 0.0 && anchor <= 1.0)) dart.assertFailed(null, I[1], 109, 15, "anchor >= 0.0 && anchor <= 1.0");
    if (!(semanticChildCount == null || dart.notNull(semanticChildCount) >= 0)) dart.assertFailed(null, I[1], 110, 15, "semanticChildCount == null || semanticChildCount >= 0");
  ...
  scroll_view.BoxScrollView = class BoxScrollView extends scroll_view.ScrollView {
    ...
    buildSlivers(context) {
      ...
      if (effectivePadding != null) sliver = new basic.SliverPadding.new({padding: effectivePadding, sliver: sliver, $creationLocationd_0dea112b090073317d4: C[19] || CT.C19});
  ...
  scroll_view.ListView = class ListView extends scroll_view.BoxScrollView {
    ...
    static ['_#separated#tearOff'](opts) {
      ...
      let restorationId = opts && 'restorationId' in opts ? opts.restorationId : null;
      let clipBehavior = opts && 'clipBehavior' in opts ? opts.clipBehavior : C[5] || CT.C5;
      return new scroll_view.ListView.separated({key: key, scrollDirection: scrollDirection, reverse: reverse, controller: controller, primary: primary, physics: physics, shrinkWrap: shrinkWrap, padding: padding, itemBuilder: itemBuilder, separatorBuilder: separatorBuilder, itemCount: itemCount, addAutomaticKeepAlives: addAutomaticKeepAlives, addRepaintBoundaries: addRepaintBoundaries, addSemanticIndexes: addSemanticIndexes, cacheExtent: cacheExtent, dragStartBehavior: dragStartBehavior, keyboardDismissBehavior: keyboardDismissBehavior, restorationId: restorationId, clipBehavior: clipBehavior, $creationLocationd_0dea112b090073317d4: C[22] || CT.C22});
    }
  ...
  (scroll_view.ListView.new = function(opts) {
    ...
    if (!(itemExtent == null || prototypeItem == null)) dart.assertFailed("You can only pass itemExtent or prototypeItem, not both.", I[1], 1074, 10, "itemExtent == null || prototypeItem == null");
  ...
  (scroll_view.ListView.builder = function(opts) {
    ...
    this[itemExtent$] = itemExtent;
    this[prototypeItem$] = prototypeItem;
    if (!(itemCount == null || dart.notNull(itemCount) >= 0)) dart.assertFailed(null, I[1], 1153, 15, "itemCount == null || itemCount >= 0");
    if (!(semanticChildCount == null || dart.notNull(semanticChildCount) <= dart.nullCheck(itemCount))) dart.assertFailed(null, I[1], 1154, 15, "semanticChildCount == null || semanticChildCount <= itemCount!");
    if (!(itemExtent == null || prototypeItem == null)) dart.assertFailed("You can only pass itemExtent or prototypeItem, not both.", I[1], 1156, 10, "itemExtent == null || prototypeItem == null");
  ...
  (scroll_view.ListView.separated = function(opts) {
    ...
    let clipBehavior = opts && 'clipBehavior' in opts ? opts.clipBehavior : C[5] || CT.C5;
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    if (!(itemBuilder !== null)) dart.assertFailed(null, I[1], 1250, 15, "itemBuilder != null");
    if (!(separatorBuilder !== null)) dart.assertFailed(null, I[1], 1251, 15, "separatorBuilder != null");
    if (!(itemCount !== null && itemCount >= 0)) dart.assertFailed(null, I[1], 1252, 15, "itemCount != null && itemCount >= 0");
    ...
    this[childrenDelegate$] = new sliver.SliverChildBuilderDelegate.new(dart.fn((context, index) => {
      ...
      if (index[$isEven]) {
        ...
        if (!dart.fn(() => {
          ...
          return true;
        }, T.VoidTobool())()) dart.assertFailed(null, I[1], 1263, 21, "() {\n               if (widget == null) {\n                 throw FlutterError('separatorBuilder cannot return null.');\n               }\n               return true;\n             }()");
      }
      return widget;
  ...
  (scroll_view.ListView.custom = function(opts) {
    ...
    if (!(childrenDelegate !== null)) dart.assertFailed(null, I[1], 1402, 15, "childrenDelegate != null");
    if (!(itemExtent == null || prototypeItem == null)) dart.assertFailed("You can only pass itemExtent or prototypeItem, not both", I[1], 1404, 10, "itemExtent == null || prototypeItem == null");
  ...
  scroll_view.GridView = class GridView extends scroll_view.BoxScrollView {
    ...
    static ['_#builder#tearOff'](opts) {
      ...
      let restorationId = opts && 'restorationId' in opts ? opts.restorationId : null;
      let clipBehavior = opts && 'clipBehavior' in opts ? opts.clipBehavior : C[5] || CT.C5;
      return new scroll_view.GridView.builder({key: key, scrollDirection: scrollDirection, reverse: reverse, controller: controller, primary: primary, physics: physics, shrinkWrap: shrinkWrap, padding: padding, gridDelegate: gridDelegate, itemBuilder: itemBuilder, itemCount: itemCount, addAutomaticKeepAlives: addAutomaticKeepAlives, addRepaintBoundaries: addRepaintBoundaries, addSemanticIndexes: addSemanticIndexes, cacheExtent: cacheExtent, semanticChildCount: semanticChildCount, dragStartBehavior: dragStartBehavior, keyboardDismissBehavior: keyboardDismissBehavior, restorationId: restorationId, clipBehavior: clipBehavior, $creationLocationd_0dea112b090073317d4: C[28] || CT.C28});
    }
    static ['_#custom#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let scrollDirection = opts && 'scrollDirection' in opts ? opts.scrollDirection : C[3] || CT.C3;
  ...
  (scroll_view.GridView.new = function(opts) {
    ...
    if (!(gridDelegate !== null)) dart.assertFailed(null, I[1], 1748, 15, "gridDelegate != null");
  ...
  (scroll_view.GridView.builder = function(opts) {
    ...
    let $36creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    this[gridDelegate$] = gridDelegate;
    if (!(gridDelegate !== null)) dart.assertFailed(null, I[1], 1812, 15, "gridDelegate != null");
  ...
  (scroll_view.GridView.custom = function(opts) {
    ...
    if (!(gridDelegate !== null)) dart.assertFailed(null, I[1], 1861, 15, "gridDelegate != null");
    if (!(childrenDelegate !== null)) dart.assertFailed(null, I[1], 1862, 15, "childrenDelegate != null");
