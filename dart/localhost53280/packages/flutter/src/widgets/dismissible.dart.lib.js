define(['dart_sdk', 'packages/flutter/src/gestures/recognizer.dart', 'packages/flutter/src/rendering/proxy_box.dart', 'packages/flutter/src/widgets/widget_inspector.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/animation/animation_controller.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/gestures/drag_details.dart', 'packages/flutter/src/gestures/velocity_tracker.dart', 'packages/flutter/src/animation/curves.dart'], (function load__packages__flutter__src__widgets__dismissible_dart(dart_sdk, packages__flutter__src__gestures__recognizer$46dart, packages__flutter__src__rendering__proxy_box$46dart, packages__flutter__src__widgets__widget_inspector$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__animation__animation_controller$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__gestures__drag_details$46dart, packages__flutter__src__gestures__velocity_tracker$46dart, packages__flutter__src__animation__curves$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C13() {
      return C[13] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 99,
        [_Location_file]: "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/dismissible.dart"
      });
    },
    get C14() {
    ...
    get C19() {
      return C[19] = dart.constList([C[16] || CT.C16, C[17] || CT.C17, C[18] || CT.C18], dismissible._FlingGestureKind);
    },
    get C20() {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/dismissible.dart"
  ];
  ...
  dismissible.DismissUpdateDetails = class DismissUpdateDetails extends core.Object {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new dismissible.DismissUpdateDetails.new({direction: direction, reached: reached, previousReached: previousReached});
    }
  };
  ...
  dismissible._DismissibleClipper = class _DismissibleClipper extends proxy_box.CustomClipper$(ui.Rect) {
    ...
    getClip(size) {
      if (!(this.axis !== null)) dart.assertFailed(null, I[1], 265, 12, "axis != null");
      switch (this.axis) {
        case C[14] || CT.C14:
        {
  ...
  (dismissible._DismissibleClipper.new = function(opts) {
    ...
    if (!(axis !== null)) dart.assertFailed(null, I[1], 256, 15, "axis != null");
    if (!(moveAnimation !== null)) dart.assertFailed(null, I[1], 257, 15, "moveAnimation != null");
  ...
  dismissible._FlingGestureKind.none = C[16] || CT.C16;
  dismissible._FlingGestureKind.forward = C[17] || CT.C17;
  dismissible._FlingGestureKind.reverse = C[18] || CT.C18;
  dismissible._FlingGestureKind.values = C[19] || CT.C19;
  ...
  dismissible._DismissibleState = class _DismissibleState extends State_AutomaticKeepAliveClientMixin$36 {
    initState() {
      ...
      this[_moveController] = (t0 = new animation_controller.AnimationController.new({duration: this.widget.movementDuration, vsync: this}), (() => {
        ...
        t0.addListener(dart.bind(this, _handleDismissUpdateValueChanged));
        return t0;
      })());
    ...
    [_handleDismissUpdateValueChanged]() {
      ...
      if (this.widget.onUpdate != null) {
        ...
        this[_dismissThresholdReached] = dart.nullCheck(this[_moveController]).value > dart.notNull((t1 = this.widget.dismissThresholds[$_get](this[_dismissDirection]), t1 == null ? 0.4 : t1));
        let details = new dismissible.DismissUpdateDetails.new({direction: this[_dismissDirection], reached: this[_dismissThresholdReached], previousReached: oldDismissThresholdReached});
    ...
    [_describeFlingGesture](velocity) {
      if (!(this.widget.direction !== null)) dart.assertFailed(null, I[1], 459, 12, "widget.direction != null");
      ...
      if (this[_directionIsXAxis]) {
        ...
        if (!(vx !== 0.0)) dart.assertFailed(null, I[1], 475, 14, "vx != 0.0");
        flingDirection = this[_extentToDirection](vx);
      } else {
        if (vy[$abs]() - vx[$abs]() < 400 || vy[$abs]() < 700) return dismissible._FlingGestureKind.none;
        if (!(vy !== 0.0)) dart.assertFailed(null, I[1], 480, 14, "vy != 0.0");
        flingDirection = this[_extentToDirection](vy);
      }
      if (!(this[_dismissDirection] !== null)) dart.assertFailed(null, I[1], 483, 12, "_dismissDirection != null");
    ...
    [_handleDragEnd](details) {
      ...
      switch (this[_describeFlingGesture](details.velocity)) {
        case C[17] || CT.C17:
        {
          if (!(this[_dragExtent] !== 0.0)) dart.assertFailed(null, I[1], 500, 16, "_dragExtent != 0.0");
          if (!!dart.nullCheck(this[_moveController]).isDismissed) dart.assertFailed(null, I[1], 501, 16, "!_moveController!.isDismissed");
        ...
        case C[18] || CT.C18:
        {
          if (!(this[_dragExtent] !== 0.0)) dart.assertFailed(null, I[1], 510, 16, "_dragExtent != 0.0");
          if (!!dart.nullCheck(this[_moveController]).isDismissed) dart.assertFailed(null, I[1], 511, 16, "!_moveController!.isDismissed");
          this[_dragExtent] = flingVelocity[$sign];
          dart.nullCheck(this[_moveController]).fling({velocity: -flingVelocity[$abs]() * 0.0033333333333333335});
          break;
        }
    ...
    [_confirmStartResizeAnimation]() {
      return async.async(core.bool, (function* _confirmStartResizeAnimation() {
        ...
        if (this.widget.confirmDismiss != null) {
          ...
          try {
            t1 = (yield dart.nullCheck(this.widget.confirmDismiss)(direction));
    ...
    [_startResizeAnimation]() {
      let t1;
      if (!dart.nullCheck(this[_moveController]).isCompleted) dart.assertFailed(null, I[1], 564, 12, "_moveController!.isCompleted");
      if (!(this[_resizeController] == null)) dart.assertFailed(null, I[1], 565, 12, "_resizeController == null");
      if (!(this[_sizePriorToCollapse] == null)) dart.assertFailed(null, I[1], 566, 12, "_sizePriorToCollapse == null");
    ...
    build(context) {
      super.build(context);
      if (!(!this[_directionIsXAxis] || debug.debugCheckHasDirectionality(context))) dart.assertFailed(null, I[1], 605, 12, "!_directionIsXAxis || debugCheckHasDirectionality(context)");
      ...
      if (this[_resizeAnimation] != null) {
        if (!dart.fn(() => {
          if (dart.nullCheck(this[_resizeAnimation]).status !== animation.AnimationStatus.forward) {
            if (!(dart.nullCheck(this[_resizeAnimation]).status === animation.AnimationStatus.completed)) dart.assertFailed(null, I[1], 618, 18, "_resizeAnimation!.status == AnimationStatus.completed");
      ...
      if (background != null) {
        content = new basic.Stack.new({children: (() => {
            ...
            if (!this[_moveAnimation].isDismissed) t1.push(new basic.Positioned.fill({child: new basic.ClipRect.new({clipper: new dismissible._DismissibleClipper.new({axis: this[_directionIsXAxis] ? basic_types.Axis.horizontal : basic_types.Axis.vertical, moveAnimation: this[_moveAnimation]}), child: background, $creationLocationd_0dea112b090073317d4: C[25] || CT.C25}), $creationLocationd_0dea112b090073317d4: C[26] || CT.C26}));
            t1.push(content);
            return t1;
          })(), $creationLocationd_0dea112b090073317d4: C[27] || CT.C27});
      }
      if (this.widget.direction === dismissible.DismissDirection.none) return content;
