define(['dart_sdk', 'packages/flutter/src/widgets/widget_inspector.dart', 'packages/flutter/src/rendering/sliver_fill.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/rendering/sliver_padding.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/foundation/debug.dart'], (function load__packages__flutter__src__widgets__sliver_fill_dart(dart_sdk, packages__flutter__src__widgets__widget_inspector$46dart, packages__flutter__src__rendering__sliver_fill$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__rendering__sliver_padding$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__foundation__debug$46dart) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C[0] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 28,
        [_Location_file]: "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/sliver_fill.dart"
      });
    },
    get C1() {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/sliver_fill.dart",
  ...
  sliver_fill$._SliverFillViewportRenderObjectWidget = class _SliverFillViewportRenderObjectWidget extends sliver.SliverMultiBoxAdaptorWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let delegate = opts && 'delegate' in opts ? opts.delegate : null;
      let viewportFraction = opts && 'viewportFraction' in opts ? opts.viewportFraction : 1;
      return new sliver_fill$._SliverFillViewportRenderObjectWidget.new({key: key, delegate: delegate, viewportFraction: viewportFraction, $creationLocationd_0dea112b090073317d4: C[3] || CT.C3});
    }
  ...
  sliver_fill$.SliverFillRemaining = class SliverFillRemaining extends framework.StatelessWidget {
    ...
    build(context) {
      if (this.hasScrollBody) return new sliver_fill$._SliverFillRemainingWithScrollable.new({child: this.child, $creationLocationd_0dea112b090073317d4: C[8] || CT.C8});
      if (!this.fillOverscroll) return new sliver_fill$._SliverFillRemainingWithoutScrollable.new({child: this.child, $creationLocationd_0dea112b090073317d4: C[9] || CT.C9});
  ...
  (sliver_fill$.SliverFillRemaining.new = function(opts) {
    ...
    if (!(hasScrollBody !== null)) dart.assertFailed(null, I[0], 268, 15, "hasScrollBody != null");
    if (!(fillOverscroll !== null)) dart.assertFailed(null, I[0], 269, 15, "fillOverscroll != null");
  ...
  sliver_fill$._SliverFillRemainingWithScrollable = class _SliverFillRemainingWithScrollable extends framework.SingleChildRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let child = opts && 'child' in opts ? opts.child : null;
      return new sliver_fill$._SliverFillRemainingWithScrollable.new({key: key, child: child, $creationLocationd_0dea112b090073317d4: C[11] || CT.C11});
    }
    createRenderObject(context) {
  ...
  sliver_fill$._SliverFillRemainingWithoutScrollable = class _SliverFillRemainingWithoutScrollable extends framework.SingleChildRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let child = opts && 'child' in opts ? opts.child : null;
      return new sliver_fill$._SliverFillRemainingWithoutScrollable.new({key: key, child: child, $creationLocationd_0dea112b090073317d4: C[12] || CT.C12});
    }
    createRenderObject(context) {
  ...
  sliver_fill$._SliverFillRemainingAndOverscroll = class _SliverFillRemainingAndOverscroll extends framework.SingleChildRenderObjectWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let child = opts && 'child' in opts ? opts.child : null;
      return new sliver_fill$._SliverFillRemainingAndOverscroll.new({key: key, child: child, $creationLocationd_0dea112b090073317d4: C[13] || CT.C13});
    }
    createRenderObject(context) {
