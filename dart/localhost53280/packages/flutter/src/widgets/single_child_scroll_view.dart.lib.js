define(['dart_sdk', 'packages/flutter/src/painting/basic_types.dart', 'packages/flutter/src/gestures/recognizer.dart', 'packages/flutter/src/widgets/scroll_view.dart', 'packages/flutter/src/widgets/widget_inspector.dart', 'packages/flutter/src/rendering/viewport_offset.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/rendering/layer.dart', 'packages/flutter/src/rendering/sliver.dart', 'packages/flutter/src/painting/matrix_utils.dart', 'packages/flutter/src/animation/curves.dart'], (function load__packages__flutter__src__widgets__single_child_scroll_view_dart(dart_sdk, packages__flutter__src__painting__basic_types$46dart, packages__flutter__src__gestures__recognizer$46dart, packages__flutter__src__widgets__scroll_view$46dart, packages__flutter__src__widgets__widget_inspector$46dart, packages__flutter__src__rendering__viewport_offset$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__rendering__layer$46dart, packages__flutter__src__rendering__sliver$46dart, packages__flutter__src__painting__matrix_utils$46dart, packages__flutter__src__animation__curves$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C[4] = dart.const({
        ...
        [_Location_column]: 9,
        [_Location_line]: 140,
        [_Location_file]: "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/single_child_scroll_view.dart"
      });
    },
    get C5() {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/widgets/single_child_scroll_view.dart",
  ...
  single_child_scroll_view.SingleChildScrollView = class SingleChildScrollView extends framework.StatelessWidget {
    ...
    build(context) {
      ...
      if (this.padding != null) contents = new basic.Padding.new({padding: dart.nullCheck(this.padding), child: contents, $creationLocationd_0dea112b090073317d4: C[5] || CT.C5});
      ...
      return this.primary && scrollController != null ? new primary_scroll_controller.PrimaryScrollController.none({child: scrollable, $creationLocationd_0dea112b090073317d4: C[9] || CT.C9}) : scrollable;
    }
  };
  (single_child_scroll_view.SingleChildScrollView.new = function(opts) {
    ...
    if (!!(controller != null && primary === true)) dart.assertFailed("Primary ScrollViews obtain their ScrollController via inheritance from a PrimaryScrollController widget. " + "You cannot both set primary to true and pass an explicit controller.", I[0], 156, 15, "!(controller != null && primary == true)");
  ...
  single_child_scroll_view._SingleChildViewport = class _SingleChildViewport extends framework.SingleChildRenderObjectWidget {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new single_child_scroll_view._SingleChildViewport.new({key: key, axisDirection: axisDirection, offset: offset, child: child, clipBehavior: clipBehavior, $creationLocationd_0dea112b090073317d4: C[11] || CT.C11});
    }
  ...
  (single_child_scroll_view._SingleChildViewport.new = function(opts) {
    ...
    if (!(axisDirection !== null)) dart.assertFailed(null, I[0], 296, 15, "axisDirection != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[0], 297, 15, "clipBehavior != null");
  ...
  single_child_scroll_view._RenderSingleChildViewport = class _RenderSingleChildViewport extends RenderBox_RenderObjectWithChildMixin$36 {
    ...
    set axisDirection(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 344, 12, "value != null");
    ...
    set offset(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 356, 12, "value != null");
    ...
    set cacheExtent(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 371, 12, "value != null");
    ...
    set clipBehavior(value) {
      if (!(value !== null)) dart.assertFailed(null, I[0], 384, 12, "value != null");
    ...
    get [_viewportExtent]() {
      if (!this.hasSize) dart.assertFailed(null, I[0], 421, 12, "hasSize");
      switch (this.axis) {
        case C[12] || CT.C12:
        {
    ...
    get [_minScrollExtent]() {
      if (!this.hasSize) dart.assertFailed(null, I[0], 431, 12, "hasSize");
      return 0.0;
    }
    get [_maxScrollExtent]() {
      if (!this.hasSize) dart.assertFailed(null, I[0], 436, 12, "hasSize");
    ...
    [_paintOffsetForPosition](position) {
      if (!(this.axisDirection !== null)) dart.assertFailed(null, I[0], 515, 12, "axisDirection != null");
    ...
    [_shouldClipAtPaintOffset](paintOffset) {
      if (!(this.child != null)) dart.assertFailed(null, I[0], 529, 12, "child != null");
    ...
    hitTestChildren(result, opts) {
      ...
      if (this.child != null) {
        return result.addWithPaintOffset({offset: this[_paintOffset], position: position, hitTest: dart.fn((result, transformed) => {
            if (!transformed._equals(position['+'](this[_paintOffset]._negate()))) dart.assertFailed(null, I[0], 589, 18, "transformed == position + -_paintOffset");
    ...
    getOffsetToReveal(target, alignment, opts) {
      ...
      if (!(this.axisDirection !== null)) dart.assertFailed(null, I[0], 612, 12, "axisDirection != null");
      switch (this.axisDirection) {
        case C[13] || CT.C13:
        {
    ...
    describeSemanticsClip(child) {
      object.RenderObject.as(child);
      if (!(this.axis !== null)) dart.assertFailed(null, I[0], 674, 12, "axis != null");
      switch (this.axis) {
        case C[0] || CT.C0:
        {
  ...
  (single_child_scroll_view._RenderSingleChildViewport.new = function(opts) {
    ...
    if (!(axisDirection !== null)) dart.assertFailed(null, I[0], 330, 15, "axisDirection != null");
    if (!(offset !== null)) dart.assertFailed(null, I[0], 331, 15, "offset != null");
    if (!(cacheExtent !== null)) dart.assertFailed(null, I[0], 332, 15, "cacheExtent != null");
    if (!(clipBehavior !== null)) dart.assertFailed(null, I[0], 333, 15, "clipBehavior != null");
