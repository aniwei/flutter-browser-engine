define(['dart_sdk', 'packages/flutter/src/foundation/print.dart', 'packages/flutter/src/foundation/_platform_web.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/stack_frame.dart'], (function load__packages__flutter__src__foundation__debug_dart(dart_sdk, packages__flutter__src__foundation__print$46dart, packages__flutter__src__foundation___platform_web$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__stack_frame$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C34() {
      return C[34] = dart.fn(assertions.FlutterError._defaultStackTraceDemangler, T$.StackTraceToStackTrace());
    },
    get C35() {
      return C[35] = dart.fn(assertions.FlutterError.dumpErrorToConsole, T$.FlutterErrorDetails__Tovoid());
    },
    get C36() {
      return C[36] = dart.fn(assertions.FlutterError.defaultStackFilter, T$.IterableOfStringToIterableOfString());
    },
    get C37() {
      return C[37] = dart.fn(assertions.DiagnosticsStackTrace._createStackFrame, T$.StringToDiagnosticsNode());
    }
  }, false);
  var C = Array(38).fill(void 0);
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/foundation/debug.dart",
    "package:flutter/src/foundation/diagnostics.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/foundation/diagnostics.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/foundation/assertions.dart",
  ...
  debug.debugInstrumentAction = function debugInstrumentAction(T, description, action) {
    return async.async(T, function* debugInstrumentAction() {
      ...
      if (!dart.fn(() => {
        ...
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[0], 68, 10, "() {\n    instrument = debugInstrumentationEnabled;\n    return true;\n  }()");
      if (instrument) {
  ...
  diagnostics$._PrefixedStringBuilder = class _PrefixedStringBuilder extends core.Object {
        ...
        switch (mode) {
          ...
          case C[27] || CT.C27:
          {
            if (index - startForLengthCalculations > width || index === message.length) {
              ...
              addPrefix = true;
              if (dart.notNull(lastWordEnd) >= message.length) return wrappedLine;
              if (lastWordEnd === index) {
                ...
                if (!(lastWordStart$35get() > dart.notNull(lastWordEnd))) dart.assertFailed(null, I[2], 938, 22, "lastWordStart > lastWordEnd");
                start = lastWordStart$35get();
                mode = diagnostics$._WordWrapParseMode.atBreak;
              }
              startForLengthCalculations = start - otherLineOffset;
              if (!addPrefix) dart.assertFailed(null, I[2], 943, 20, "addPrefix");
              lastWordEnd = null;
            } else {
              lastWordEnd = index;
    ...
    writeRawLines(lines) {
      ...
      if (!this[_currentLine].isEmpty) dart.assertFailed(null, I[2], 1019, 13, "_currentLine.isEmpty");
    ...
    writeStretched(text, targetLineLength) {
      ...
      if (!(this[_currentLine].length > 0)) dart.assertFailed(null, I[2], 1032, 13, "_currentLine.length > 0");
      let targetLength = targetLineLength - currentLineLength;
      if (targetLength > 0) {
        if (!text[$isNotEmpty]) dart.assertFailed(null, I[2], 1035, 14, "text.isNotEmpty");
        let lastChar = text[$_get](text.length - 1);
        if (!(lastChar !== "\n")) dart.assertFailed(null, I[2], 1037, 14, "lastChar != '\\n'");
    ...
    [_debugRender](node, opts) {
      ...
      if (children[$isNotEmpty] && config.showChildren) {
        ...
        for (let i = 0; i < children[$length]; i = i + 1) {
          ...
          if (!(child !== null)) dart.assertFailed(null, I[2], 1350, 16, "child != null");
  ...
  (diagnostics$.TextTreeRenderer.new = function(opts) {
    ...
    let wrapWidthProperties = opts && 'wrapWidthProperties' in opts ? opts.wrapWidthProperties : 65;
    let maxDescendentsTruncatableNode = opts && 'maxDescendentsTruncatableNode' in opts ? opts.maxDescendentsTruncatableNode : -1;
    if (!(minLevel !== null)) dart.assertFailed(null, I[2], 1086, 15, "minLevel != null");
  ...
  diagnostics$.DiagnosticsNode = class DiagnosticsNode extends core.Object {
    ...
    static message(message, opts) {
      ...
      if (!(style !== null)) dart.assertFailed(null, I[2], 1452, 12, "style != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 1453, 12, "level != null");
    ...
    toTimelineArguments() {
      let result = T$.LinkedHashMapOfString$String().of(debug.timelineArgumentsIndicatingLandmarkEvent);
      if (!false) {
        if (false) {
          dart.throw(assertions.FlutterError.new(dart.str(dart.wrapType(diagnostics$.DiagnosticsNode)) + ".toTimelineArguments used in non-debug build.\n" + "The " + dart.str(dart.wrapType(diagnostics$.DiagnosticsNode)) + ".toTimelineArguments API is expensive and causes timeline traces " + "to be non-representative. As such, it should not be used in profile builds. However, " + "this application is compiled in profile mode and yet still invoked the method."));
        }
    ...
    toJsonMap(delegate) {
      ...
      if (!dart.fn(() => {
        ...
        result = (() => {
          ...
          if (this.level !== diagnostics$.DiagnosticLevel.info) t4[$_set]("level", core['EnumName|get#name'](this.level));
          ...
          if (this.style !== diagnostics$.DiagnosticsTreeStyle.sparse) t4[$_set]("style", core['EnumName|get#name'](dart.nullCheck(this.style)));
    ...
    toString(opts) {
      ...
      if (!(this.style != null)) dart.assertFailed(null, I[2], 1690, 12, "style != null");
      if (!(minLevel !== null)) dart.assertFailed(null, I[2], 1691, 12, "minLevel != null");
      if (!dart.fn(() => {
    ...
    toStringDeep(opts) {
      ...
      if (!dart.fn(() => {
        ...
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[2], 1772, 12, "() {\n      result = TextTreeRenderer(\n        minLevel: minLevel,\n        wrapWidth: 65,\n      ).render(\n        this,\n        prefixLineOne: prefixLineOne,\n        prefixOtherLines: prefixOtherLines,\n        parentConfiguration: parentConfiguration,\n      );\n      return true;\n    }()");
      return result;
    }
  };
  (diagnostics$.DiagnosticsNode.new = function(opts) {
    ...
    if (!(showName !== null)) dart.assertFailed(null, I[2], 1425, 15, "showName != null");
    if (!(showSeparator !== null)) dart.assertFailed(null, I[2], 1426, 15, "showSeparator != null");
    if (!(name == null || !name[$endsWith](":"))) dart.assertFailed("Names of diagnostic nodes must not end with colons.\n" + "name:\n" + "  \"" + dart.str(name) + "\"", I[2], 1431, 10, "name == null || !name.endsWith(':')");
    ;
  ...
  dart.setMethodSignature(diagnostics$.DiagnosticsNode, () => ({
    ...
    toTimelineArguments: dart.fnType(core.Map$(core.String, core.String), []),
  ...
  diagnostics$.DiagnosticsProperty$ = dart.generic(T => {
    ...
    class DiagnosticsProperty extends diagnostics$.DiagnosticsNode {
      ...
      [_addTooltip](text) {
        if (!(text !== null)) dart.assertFailed(null, I[2], 2803, 12, "text != null");
      ...
      [_maybeCacheValue]() {
        ...
        if (!(this[_computeValue] != null)) dart.assertFailed(null, I[2], 2873, 12, "_computeValue != null");
        try {
      ...
      get level() {
        ...
        if (!this.isInteresting) return diagnostics$.DiagnosticLevel.fine;
    ...
    (DiagnosticsProperty.new = function(name, value, opts) {
      ...
      if (!(showName !== null)) dart.assertFailed(null, I[2], 2641, 15, "showName != null");
      if (!(showSeparator !== null)) dart.assertFailed(null, I[2], 2642, 15, "showSeparator != null");
      if (!(style !== null)) dart.assertFailed(null, I[2], 2643, 15, "style != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2644, 15, "level != null");
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      this[allowWrap$] = allowWrap;
      this[allowNameWrap$] = allowNameWrap;
      if (!(showName !== null)) dart.assertFailed(null, I[2], 2687, 15, "showName != null");
      if (!(showSeparator !== null)) dart.assertFailed(null, I[2], 2688, 15, "showSeparator != null");
      if (!(dart.equals(defaultValue, diagnostics$.kNoDefaultValue) || __t$TN().is(defaultValue))) dart.assertFailed(null, I[2], 2689, 15, "defaultValue == kNoDefaultValue || defaultValue is T?");
      if (!(missingIfNull !== null)) dart.assertFailed(null, I[2], 2690, 15, "missingIfNull != null");
      if (!(style !== null)) dart.assertFailed(null, I[2], 2691, 15, "style != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2692, 15, "level != null");
      this[_description] = description;
  ...
  (diagnostics$.MessageProperty.new = function(name, message, opts) {
    let style = opts && 'style' in opts ? opts.style : C[20] || CT.C20;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(name !== null)) dart.assertFailed(null, I[2], 1829, 15, "name != null");
    if (!(message !== null)) dart.assertFailed(null, I[2], 1830, 15, "message != null");
    if (!(style !== null)) dart.assertFailed(null, I[2], 1831, 15, "style != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 1832, 15, "level != null");
  ...
  (diagnostics$.StringProperty.new = function(name, value, opts) {
    ...
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    this[quoted$] = quoted;
    if (!(showName !== null)) dart.assertFailed(null, I[2], 1857, 15, "showName != null");
    if (!(quoted !== null)) dart.assertFailed(null, I[2], 1858, 15, "quoted != null");
    if (!(style !== null)) dart.assertFailed(null, I[2], 1859, 15, "style != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 1860, 15, "level != null");
  ...
  (diagnostics$.DoubleProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : C[20] || CT.C20;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(showName !== null)) dart.assertFailed(null, I[2], 1994, 15, "showName != null");
    if (!(style !== null)) dart.assertFailed(null, I[2], 1995, 15, "style != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 1996, 15, "level != null");
  ...
  (diagnostics$.DoubleProperty.lazy = function(name, computeValue, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C[30] || CT.C30;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(showName !== null)) dart.assertFailed(null, I[2], 2024, 15, "showName != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 2025, 15, "level != null");
  ...
  (diagnostics$.IntProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : C[20] || CT.C20;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(showName !== null)) dart.assertFailed(null, I[2], 2057, 15, "showName != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 2058, 15, "level != null");
    if (!(style !== null)) dart.assertFailed(null, I[2], 2059, 15, "style != null");
  ...
  (diagnostics$.PercentProperty.new = function(name, fraction, opts) {
    ...
    let unit = opts && 'unit' in opts ? opts.unit : null;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(showName !== null)) dart.assertFailed(null, I[2], 2094, 15, "showName != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 2095, 15, "level != null");
  ...
  (diagnostics$.FlagProperty.new = function(name, opts) {
    ...
    if (!(showName !== null)) dart.assertFailed(null, I[2], 2176, 15, "showName != null");
    if (!(level !== null)) dart.assertFailed(null, I[2], 2177, 15, "level != null");
    if (!(ifTrue != null || ifFalse != null)) dart.assertFailed(null, I[2], 2178, 15, "ifTrue != null || ifFalse != null");
  ...
  diagnostics$.IterableProperty$ = dart.generic(T => {
    ...
    (IterableProperty.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
      if (!(style !== null)) dart.assertFailed(null, I[2], 2274, 15, "style != null");
      if (!(showName !== null)) dart.assertFailed(null, I[2], 2275, 15, "showName != null");
      if (!(showSeparator !== null)) dart.assertFailed(null, I[2], 2276, 15, "showSeparator != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2277, 15, "level != null");
  ...
  diagnostics$.EnumProperty$ = dart.generic(T => {
    ...
    (EnumProperty.new = function(name, value, opts) {
      let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C[30] || CT.C30;
      let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
      if (!(level !== null)) dart.assertFailed(null, I[2], 2363, 15, "level != null");
  ...
  diagnostics$.ObjectFlagProperty$ = dart.generic(T => {
    ...
    (ObjectFlagProperty.new = function(name, value, opts) {
      ...
      if (!(ifPresent != null || ifNull != null)) dart.assertFailed(null, I[2], 2415, 15, "ifPresent != null || ifNull != null");
      if (!(showName !== null)) dart.assertFailed(null, I[2], 2416, 15, "showName != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2417, 15, "level != null");
    ...
    (ObjectFlagProperty.has = function(name, value, opts) {
      let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
      if (!(name !== null)) dart.assertFailed(null, I[2], 2436, 15, "name != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2437, 15, "level != null");
  ...
  diagnostics$.FlagsSummary$ = dart.generic(T => {
    ...
    class FlagsSummary extends diagnostics$.DiagnosticsProperty$(core.Map$(core.String, dart.nullable(T))) {
      ...
      valueToString(opts) {
        let parentConfiguration = opts && 'parentConfiguration' in opts ? opts.parentConfiguration : null;
        if (!(this.value !== null)) dart.assertFailed(null, I[2], 2551, 12, "value != null");
    ...
    (FlagsSummary.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
      if (!(value !== null)) dart.assertFailed(null, I[2], 2533, 15, "value != null");
      if (!(showName !== null)) dart.assertFailed(null, I[2], 2534, 15, "showName != null");
      if (!(showSeparator !== null)) dart.assertFailed(null, I[2], 2535, 15, "showSeparator != null");
      if (!(level !== null)) dart.assertFailed(null, I[2], 2536, 15, "level != null");
  ...
  diagnostics$.DiagnosticableNode$ = dart.generic(T => {
    class DiagnosticableNode extends diagnostics$.DiagnosticsNode {
      ...
      toDescription(opts) {
        ...
        if (!dart.fn(() => {
          ...
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[2], 3019, 12, "() {\n      result = value.toStringShort();\n      return true;\n    }()");
        return result;
      }
    }
    (DiagnosticableNode.new = function(opts) {
      ...
      this[value$] = value;
      if (!(value !== null)) dart.assertFailed(null, I[2], 2971, 15, "value != null");
    ...
    class Diagnosticable extends Object {
      ...
      toString(opts) {
        ...
        if (!dart.fn(() => {
          ...
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[2], 3167, 12, "() {\n      fullString = toDiagnosticsNode(style: DiagnosticsTreeStyle.singleLine).toString(minLevel: minLevel);\n      return true;\n    }()");
        t7 = fullString;
    ...
    class DiagnosticableTreeMixin extends Object {
      ...
      toStringShallow(opts) {
        ...
        if (!dart.fn(() => {
          ...
          shallowString = result.toString();
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[2], 3533, 12, "() {\n      final StringBuffer result = StringBuffer();\n      result.write(toStringShort());\n      result.write(joiner);\n      final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();\n      debugFillProperties(builder);\n      result.write(\n        builder.properties.where((DiagnosticsNode n) => !n.isFiltered(minLevel))\n            .join(joiner),\n      );\n      shallowString = result.toString();\n      return true;\n    }()");
        t7 = shallowString;
        return t7 == null ? this.toString() : t7;
      }
      toStringDeep(opts) {
  ...
  (diagnostics$.DiagnosticsBlock.new = function(opts) {
    ...
    this[_description] = (t7 = description, t7 == null ? "" : t7);
  ...
  diagnostics$.describeEnum = function describeEnum(enumEntry) {
    if (core.Enum.is(enumEntry)) return core['EnumName|get#name'](enumEntry);
    let description = enumEntry[$toString]();
    let indexOfDot = description[$indexOf](".");
    if (!(indexOfDot !== -1 && indexOfDot < description.length - 1)) dart.assertFailed("The provided object \"" + dart.str(enumEntry) + "\" is not an enum.", I[2], 3094, 5, "indexOfDot != -1 && indexOfDot < description.length - 1");
  ...
  (assertions.PartialStackFrame.new = function(opts) {
    ...
    this[method$] = method;
    if (!(className !== null)) dart.assertFailed(null, I[3], 51, 15, "className != null");
    if (!(method !== null)) dart.assertFailed(null, I[3], 52, 15, "method != null");
    if (!($package !== null)) dart.assertFailed(null, I[3], 53, 15, "package != null");
    ;
  ...
  (assertions.RepetitiveStackFrameFilter.new = function(opts) {
    ...
    if (!(frames !== null)) dart.assertFailed(null, I[3], 125, 15, "frames != null");
    if (!(replacement !== null)) dart.assertFailed(null, I[3], 126, 15, "replacement != null");
  ...
  (assertions._ErrorDiagnostic.new = function(message, opts) {
    ...
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(message !== null)) dart.assertFailed(null, I[3], 174, 15, "message != null");
  ...
  (assertions._ErrorDiagnostic._fromParts = function(messageParts, opts) {
    let style = opts && 'style' in opts ? opts.style : C[19] || CT.C19;
    let level = opts && 'level' in opts ? opts.level : C[5] || CT.C5;
    if (!(messageParts !== null)) dart.assertFailed(null, I[3], 214, 15, "messageParts != null");
  ...
  (assertions.FlutterErrorDetails.new = function(opts) {
    ...
    this[silent$] = silent;
    if (!(exception !== null)) dart.assertFailed(null, I[3], 404, 15, "exception != null");
    ;
  ...
  assertions.FlutterError = class FlutterError extends Error_DiagnosticableTreeMixin$36 {
    ...
    static dumpErrorToConsole(details, opts) {
      ...
      if (!(details !== null)) dart.assertFailed(null, I[3], 996, 12, "details != null");
      if (!(details.exception !== null)) dart.assertFailed(null, I[3], 997, 12, "details.exception != null");
      let isInDebugMode = false;
      if (!dart.fn(() => {
        isInDebugMode = true;
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[3], 999, 12, "() {\n      // In debug mode, we ignore the \"silent\" flag.\n      isInDebugMode = true;\n      return true;\n    }()");
    ...
    static defaultStackFilter(frames) {
      ...
      let where = (t9 = (() => {
        ...
        for (let entry of removedPackagesAndClasses[$entries])
          if (entry.value > 0) t8.push(entry.key);
        return t8;
      })(), (() => {
        t9[$sort]();
        return t9;
    ...
    static reportError(details) {
      let t9;
      if (!(details !== null)) dart.assertFailed(null, I[3], 1175, 12, "details != null");
      if (!(details.exception !== null)) dart.assertFailed(null, I[3], 1176, 12, "details.exception != null");
  ...
  assertions.DiagnosticsStackTrace = class DiagnosticsStackTrace extends diagnostics$.DiagnosticsBlock {
    ...
    static _applyStackFilter(stack, stackFilter) {
      ...
      let filter = (t9 = stackFilter, t9 == null ? C[36] || CT.C36 : t9);
      let frames = filter(dart.str(assertions.FlutterError.demangleStackTrace(stack))[$trimRight]()[$split]("\n"));
      return frames[$map](diagnostics$.DiagnosticsNode, C[37] || CT.C37)[$toList]();
    }
