define(['dart_sdk', 'packages/flutter/src/painting/borders.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/painting/border_radius.dart'], (function load__packages__flutter__src__material__input_border_dart(dart_sdk, packages__flutter__src__painting__borders$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__painting__border_radius$46dart) {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/material/input_border.dart",
  ...
  input_border.OutlineInputBorder = class OutlineInputBorder extends input_border.InputBorder {
    ...
    [_gapBorderPath](canvas, center, start, extent) {
      ...
      let tlCornerArcSweep = math.acos((1 - start / scaledRRect.tlRadiusX)[$clamp](0.0, 1.0));
      ...
      if (start + extent < scaledRRect.width - scaledRRect.trRadiusX) {
        ...
        let sweep = math.asin((1 - dx / scaledRRect.trRadiusX)[$clamp](0.0, 1.0));
    ...
    paint(canvas, rect, opts) {
      ...
      let gapPercentage = opts && 'gapPercentage' in opts ? opts.gapPercentage : 0;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      if (!(gapExtent !== null)) dart.assertFailed(null, I[0], 472, 12, "gapExtent != null");
      if (!(gapPercentage >= 0.0 && gapPercentage <= 1.0)) dart.assertFailed(null, I[0], 473, 12, "gapPercentage >= 0.0 && gapPercentage <= 1.0");
      if (!input_border.OutlineInputBorder._cornersAreCircular(this.borderRadius)) dart.assertFailed(null, I[0], 474, 12, "_cornersAreCircular(borderRadius)");
  ...
  (input_border.OutlineInputBorder.new = function(opts) {
    ...
    if (!(borderRadius !== null)) dart.assertFailed(null, I[0], 291, 15, "borderRadius != null");
    if (!(gapPadding !== null && gapPadding >= 0.0)) dart.assertFailed(null, I[0], 292, 15, "gapPadding != null && gapPadding >= 0.0");
