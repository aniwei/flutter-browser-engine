define(['dart_sdk', 'packages/flutter/src/gestures/events.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/services/restoration.dart', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__services__mouse_cursor_dart(dart_sdk, packages__flutter__src__gestures__events$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__services__restoration$46dart, packages__flutter__src__foundation__object$46dart) {
  'use strict';
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/services/mouse_cursor.dart",
  ...
  mouse_cursor._DeferringMouseCursor = class _DeferringMouseCursor extends mouse_cursor.MouseCursor {
    ...
    createSession(device) {
      if (!false) dart.assertFailed("_DeferringMouseCursor can not create a session", I[0], 250, 12, "false");
    ...
    static firstNonDeferred(cursors) {
      for (let cursor of cursors) {
        if (!(cursor !== null)) dart.assertFailed(null, I[0], 260, 14, "cursor != null");
  ...
  (mouse_cursor.SystemMouseCursor.__ = function(opts) {
    let kind = opts && 'kind' in opts ? opts.kind : null;
    this[kind$] = kind;
    if (!(kind !== null)) dart.assertFailed(null, I[0], 357, 15, "kind != null");
