define(['dart_sdk', 'packages/flutter/src/foundation/object.dart'], (function load__packages__flutter__src__animation__curves_dart(dart_sdk, packages__flutter__src__foundation__object$46dart) {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/curves.dart",
  ...
  (curves.Cubic.new = function(a, b, c, d) {
    ...
    this[c$] = c;
    this[d$] = d;
    if (!(a !== null)) dart.assertFailed(null, I[0], 307, 14, "a != null");
    if (!(b !== null)) dart.assertFailed(null, I[0], 308, 14, "b != null");
    if (!(c !== null)) dart.assertFailed(null, I[0], 309, 14, "c != null");
    if (!(d !== null)) dart.assertFailed(null, I[0], 310, 14, "d != null");
  ...
  curves.Curve2D = class Curve2D extends curves.ParametricCurve$(ui.Offset) {
    generateSamples(opts) {
      ...
      if (!(tolerance !== null)) dart.assertFailed(null, I[0], 515, 12, "tolerance != null");
      if (!(start !== null)) dart.assertFailed(null, I[0], 516, 12, "start != null");
      if (!(end !== null)) dart.assertFailed(null, I[0], 517, 12, "end != null");
      if (!(end > start)) dart.assertFailed(null, I[0], 518, 12, "end > start");
    ...
    findInverse(x) {
      if (!(x !== null)) dart.assertFailed(null, I[0], 574, 12, "x != null");
      let start = 0.0;
      let end = 1.0;
      let mid = null;
      function mid$35get() {
  ...
  (curves.Curve2DSample.new = function(t, value) {
    this[t$] = t;
    this[value$] = value;
    if (!(t !== null)) dart.assertFailed(null, I[0], 609, 52, "t != null");
    if (!(value !== null)) dart.assertFailed(null, I[0], 609, 71, "value != null");
    ;
  ...
  (curves.CatmullRomSpline.new = function(controlPoints, opts) {
    ...
    let startHandle = opts && 'startHandle' in opts ? opts.startHandle : null;
    let endHandle = opts && 'endHandle' in opts ? opts.endHandle : null;
    if (!(controlPoints !== null)) dart.assertFailed(null, I[0], 679, 19, "controlPoints != null");
    if (!(tension !== null)) dart.assertFailed(null, I[0], 680, 19, "tension != null");
    if (!(tension <= 1.0)) dart.assertFailed("tension " + dart.str(tension) + " must not be greater than 1.0.", I[0], 681, 19, "tension <= 1.0");
    if (!(tension >= 0.0)) dart.assertFailed("tension " + dart.str(tension) + " must not be negative.", I[0], 682, 19, "tension >= 0.0");
    if (!(controlPoints[$length] > 3)) dart.assertFailed("There must be at least four control points to create a CatmullRomSpline.", I[0], 683, 19, "controlPoints.length > 3");
  ...
  (curves.CatmullRomSpline.precompute = function(controlPoints, opts) {
    ...
    let startHandle = opts && 'startHandle' in opts ? opts.startHandle : null;
    let endHandle = opts && 'endHandle' in opts ? opts.endHandle : null;
    if (!(controlPoints !== null)) dart.assertFailed(null, I[0], 699, 19, "controlPoints != null");
    if (!(tension !== null)) dart.assertFailed(null, I[0], 700, 19, "tension != null");
    if (!(tension <= 1.0)) dart.assertFailed("tension " + dart.str(tension) + " must not be greater than 1.0.", I[0], 701, 19, "tension <= 1.0");
    if (!(tension >= 0.0)) dart.assertFailed("tension " + dart.str(tension) + " must not be negative.", I[0], 702, 19, "tension >= 0.0");
    if (!(controlPoints[$length] > 3)) dart.assertFailed("There must be at least four control points to create a CatmullRomSpline.", I[0], 703, 19, "controlPoints.length > 3");
  ...
  curves.CatmullRomCurve = class CatmullRomCurve extends curves.Curve {
    ...
    static validateControlPoints(controlPoints, opts) {
      ...
      if (!(tension !== null)) dart.assertFailed(null, I[0], 960, 12, "tension != null");
  ...
  (curves.CatmullRomCurve.new = function(controlPoints, opts) {
    ...
    if (!(tension !== null)) dart.assertFailed(null, I[0], 857, 16, "tension != null");
    if (!dart.fn(() => {
      let t5;
  ...
  (curves.CatmullRomCurve.precompute = function(controlPoints, opts) {
    ...
    this[controlPoints$] = controlPoints;
    this[tension$] = tension;
    if (!(tension !== null)) dart.assertFailed(null, I[0], 874, 16, "tension != null");
    if (!dart.fn(() => {
      let t5;
      return curves.CatmullRomCurve.validateControlPoints(controlPoints, {tension: tension, reasons: (t5 = curves.CatmullRomCurve._debugAssertReasons, (() => {
          t5[$clear]();
  ...
  (curves.FlippedCurve.new = function(curve) {
    this[curve$0] = curve;
    if (!(curve !== null)) dart.assertFailed(null, I[0], 1140, 43, "curve != null");
