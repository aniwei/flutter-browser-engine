define(['dart_sdk', 'packages/flutter/src/foundation/observer_list.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/foundation/change_notifier.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/animation/curves.dart'], (function load__packages__flutter__src__animation__listener_helpers_dart(dart_sdk, packages__flutter__src__foundation__observer_list$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__foundation__change_notifier$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__animation__curves$46dart) {
  ...
  var T$ = {
    ...
    ListOfAnimationStatusTovoid: () => (T$.ListOfAnimationStatusTovoid = dart.constFn(core.List$(T$.AnimationStatusTovoid())))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C6() {
      return C[6] = dart.constList([C[4] || CT.C4, C[5] || CT.C5], animations._TrainHoppingMode);
    },
    get C7() {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/listener_helpers.dart",
    "package:flutter/src/animation/listener_helpers.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/animation.dart",
    "package:flutter/src/animation/animation.dart",
    "package:flutter/src/animation/animations.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/animations.dart",
    "package:flutter/src/animation/tween.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/tween.dart"
  ];
  ...
  listener_helpers.AnimationLazyListenerMixin[dart.mixinOn] = Object => class AnimationLazyListenerMixin extends Object {
    didRegisterListener() {
      if (!(this[_listenerCounter] >= 0)) dart.assertFailed(null, I[0], 28, 12, "_listenerCounter >= 0");
      if (this[_listenerCounter] === 0) this.didStartListening();
      this[_listenerCounter] = this[_listenerCounter] + 1;
    }
    didUnregisterListener() {
      if (!(this[_listenerCounter] >= 1)) dart.assertFailed(null, I[0], 42, 12, "_listenerCounter >= 1");
      this[_listenerCounter] = this[_listenerCounter] - 1;
  ...
  listener_helpers.AnimationLocalListenersMixin[dart.mixinOn] = Object => class AnimationLocalListenersMixin extends Object {
    ...
    notifyListeners() {
      let localListeners = T$.ListOfVoidTovoid().of(this[_listeners]);
  ...
  listener_helpers.AnimationLocalStatusListenersMixin[dart.mixinOn] = Object => class AnimationLocalStatusListenersMixin extends Object {
    ...
    notifyStatusListeners(status) {
      let localListeners = T$.ListOfAnimationStatusTovoid().of(this[_statusListeners]);
      for (let listener of localListeners) {
        try {
          if (this[_statusListeners].contains(listener)) listener(status);
        } catch (e) {
          let exception = dart.getThrown(e);
          let stack = dart.stackTrace(e);
          if (core.Object.is(exception)) {
  ...
  animation$.Animation$ = dart.generic(T => {
    class Animation extends change_notifier.Listenable {
      ...
      drive(U, child) {
        if (!T$.AnimationOfdouble().is(this)) dart.assertFailed(null, I[2], 169, 12, "this is Animation<double>");
      ...
      toStringDetails() {
        if (!(this.status !== null)) dart.assertFailed(null, I[2], 193, 12, "status != null");
        switch (this.status) {
          case C[0] || CT.C0:
          {
            return "▶";
  ...
  animations.ProxyAnimation = class ProxyAnimation extends Animation_AnimationLocalStatusListenersMixin$36 {
    ...
    set parent(value) {
      ...
      if (this[_parent] != null) {
        ...
        if (this.isListening) this.didStopListening();
      }
      this[_parent] = value;
      if (this[_parent] != null) {
        if (this.isListening) this.didStartListening();
        if (this[_value] !== dart.nullCheck(this[_parent]).value) this.notifyListeners();
        if (this[_status] !== dart.nullCheck(this[_parent]).status) this.notifyStatusListeners(dart.nullCheck(this[_parent]).status);
        this[_status] = null;
        this[_value] = null;
      }
    }
    ...
    toString() {
      if (this.parent == null) return object.objectRuntimeType(this, "ProxyAnimation") + "(null; " + super.toStringDetails() + " " + this.value[$toStringAsFixed](3) + ")";
  ...
  animations.ReverseAnimation = class ReverseAnimation extends Animation_AnimationLocalStatusListenersMixin$36$ {
    ...
    [_reverseStatus](status) {
      if (!(status !== null)) dart.assertFailed(null, I[5], 302, 12, "status != null");
      switch (status) {
        case C[0] || CT.C0:
        {
  ...
  (animations.ReverseAnimation.new = function(parent) {
    this[parent$] = parent;
    if (!(parent !== null)) dart.assertFailed(null, I[5], 264, 14, "parent != null");
  ...
  animations.CurvedAnimation = class CurvedAnimation extends Animation_AnimationWithParentMixin$36 {
    ...
    toString() {
      ...
      if (this[_useForwardCurve]) return dart.str(this.parent) + "➩" + dart.str(this.curve) + "ₒₙ/" + dart.str(this.reverseCurve);
  ...
  (animations.CurvedAnimation.new = function(opts) {
    ...
    if (!(parent !== null)) dart.assertFailed(null, I[5], 376, 15, "parent != null");
    if (!(curve !== null)) dart.assertFailed(null, I[5], 377, 15, "curve != null");
  ...
  animations._TrainHoppingMode.minimize = C[4] || CT.C4;
  animations._TrainHoppingMode.maximize = C[5] || CT.C5;
  animations._TrainHoppingMode.values = C[6] || CT.C6;
  ...
  animations.TrainHoppingAnimation = class TrainHoppingAnimation extends Animation_AnimationLocalStatusListenersMixin$36$0 {
    ...
    [_statusChangeHandler](status) {
      if (!(this[_currentTrain$] != null)) dart.assertFailed(null, I[5], 543, 12, "_currentTrain != null");
      if (status !== this[_lastStatus]) {
        this.notifyListeners();
        this[_lastStatus] = status;
      }
      if (!(this[_lastStatus] != null)) dart.assertFailed(null, I[5], 548, 12, "_lastStatus != null");
    }
    get status() {
    ...
    [_valueChangeHandler]() {
      let t2;
      if (!(this[_currentTrain$] != null)) dart.assertFailed(null, I[5], 556, 12, "_currentTrain != null");
      let hop = false;
      if (this[_nextTrain$] != null) {
        if (!(this[_mode] != null)) dart.assertFailed(null, I[5], 559, 14, "_mode != null");
      ...
      if (!(this[_lastValue] != null)) dart.assertFailed(null, I[5], 583, 12, "_lastValue != null");
    ...
    dispose() {
      let t2;
      if (!(this[_currentTrain$] != null)) dart.assertFailed(null, I[5], 595, 12, "_currentTrain != null");
    ...
    toString() {
      if (this[_nextTrain$] != null) return dart.str(this.currentTrain) + "➩" + object.objectRuntimeType(this, "TrainHoppingAnimation") + "(next: " + dart.str(this[_nextTrain$]) + ")";
  ...
  (animations.TrainHoppingAnimation.new = function(_currentTrain, _nextTrain, opts) {
    ...
    if (!(_currentTrain !== null)) dart.assertFailed(null, I[5], 507, 15, "_currentTrain != null");
    ...
    if (this[_nextTrain$] != null) {
      if (dart.nullCheck(this[_currentTrain$]).value === dart.nullCheck(this[_nextTrain$]).value) {
        ...
        if (!(dart.nullCheck(this[_currentTrain$]).value < dart.nullCheck(this[_nextTrain$]).value)) dart.assertFailed(null, I[5], 515, 16, "_currentTrain!.value < _nextTrain!.value");
    ...
    if (!(this[_mode] != null || this[_nextTrain$] == null)) dart.assertFailed(null, I[5], 522, 12, "_mode != null || _nextTrain == null");
  ...
  animations.CompoundAnimation$ = dart.generic(T => {
    ...
    (CompoundAnimation.new = function(opts) {
      ...
      this[first$] = first;
      this[next$] = next;
      if (!(first !== null)) dart.assertFailed(null, I[5], 631, 15, "first != null");
      if (!(next !== null)) dart.assertFailed(null, I[5], 632, 15, "next != null");
  ...
  tween.Tween$ = dart.generic(T => {
    ...
    class Tween extends tween.Animatable$(T) {
      ...
      lerp(t) {
        if (!(this.begin != null)) dart.assertFailed(null, I[7], 257, 12, "begin != null");
        if (!(this.end != null)) dart.assertFailed(null, I[7], 258, 12, "end != null");
        if (!dart.fn(() => {
          let result = null;
          try {
            ...
            if (core.NoSuchMethodError.is(ex)) {
              dart.throw(new assertions.FlutterError.fromParts((() => {
                ...
                if (ui.Color.is(this.begin) || ui.Color.is(this.end))
                  t5.push(new assertions.ErrorHint.new("To lerp colors, consider ColorTween instead."));
                else if (ui.Rect.is(this.begin) || ui.Rect.is(this.end))
                  t5.push(new assertions.ErrorHint.new("To lerp rects, consider RectTween instead."));
                else
  ...
  tween.ReverseTween$ = dart.generic(T => {
    ...
    (ReverseTween.new = function(parent) {
      ...
      if (!(parent !== null)) dart.assertFailed(null, I[7], 338, 14, "parent != null");
  ...
  tween.CurveTween = class CurveTween extends tween.Animatable$(core.double) {
    ...
    transform(t) {
      if (t === 0.0 || t === 1.0) {
        if (!(this.curve.transform(t)[$round]() === t)) dart.assertFailed(null, I[7], 527, 14, "curve.transform(t).round() == t");
        return t;
      }
  ...
  (tween.CurveTween.new = function(opts) {
    let curve = opts && 'curve' in opts ? opts.curve : null;
    this[curve$0] = curve;
    if (!(curve !== null)) dart.assertFailed(null, I[7], 519, 14, "curve != null");
  ...
  animation$.AnimationStatus.dismissed = C[3] || CT.C3;
  animation$.AnimationStatus.forward = C[0] || CT.C0;
  animation$.AnimationStatus.reverse = C[1] || CT.C1;
  animation$.AnimationStatus.completed = C[2] || CT.C2;
  animation$.AnimationStatus.values = C[9] || CT.C9;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["listener_helpers.dart","animation.dart","animations.dart","tween.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2BI,YAAO,AAAiB,0BAAG;AAC3B,UAAI,AAAiB,2BAAG,GACtB,AAAmB;AACA,MAArB,yBAAA,AAAiB,yBAAG;IACtB;;AAUE,YAAO,AAAiB,0BAAG;AACN,MAArB,yBAAA,AAAiB,yBAAG;AACpB,UAAI,AAAiB,2BAAG,GACtB,AAAkB;IACtB;;AAWwB,YAAA,AAAiB,0BAAE;IAAC;;;IAzCxC,yBAAmB;;;;;;;;;;;;;;;;;;;;;;IAqDM;;IAIE;;IAKd;;;;;;;;;;;;;;;;;gBA6Ba;