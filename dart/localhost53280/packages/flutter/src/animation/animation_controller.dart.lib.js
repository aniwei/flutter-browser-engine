define(['dart_sdk', 'packages/flutter/src/animation/listener_helpers.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/animation/curves.dart', 'packages/flutter/src/semantics/binding.dart', 'packages/flutter/src/scheduler/ticker.dart', 'packages/flutter/src/physics/spring_simulation.dart', 'packages/flutter/src/physics/simulation.dart', 'packages/flutter/src/physics/tolerance.dart'], (function load__packages__flutter__src__animation__animation_controller_dart(dart_sdk, packages__flutter__src__animation__listener_helpers$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__animation__curves$46dart, packages__flutter__src__semantics__binding$46dart, packages__flutter__src__scheduler__ticker$46dart, packages__flutter__src__physics__spring_simulation$46dart, packages__flutter__src__physics__simulation$46dart, packages__flutter__src__physics__tolerance$46dart) {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/animation/animation_controller.dart"
  ];
  ...
  animation_controller.AnimationController = class AnimationController extends Animation_AnimationLocalStatusListenersMixin$36 {
    ...
    set value(newValue) {
      if (!(newValue !== null)) dart.assertFailed(null, I[1], 362, 12, "newValue != null");
      this.stop();
    ...
    [_animateToInternal](target, opts) {
      ...
      if (simulationDuration == null) {
        if (!!(this.duration == null && this[_direction] === animation_controller._AnimationDirection.forward)) dart.assertFailed(null, I[1], 585, 14, "!(this.duration == null && _direction == _AnimationDirection.forward)");
        if (!!(this.duration == null && this[_direction] === animation_controller._AnimationDirection.reverse && this.reverseDuration == null)) dart.assertFailed(null, I[1], 586, 14, "!(this.duration == null && _direction == _AnimationDirection.reverse && reverseDuration == null)");
      ...
      if (!simulationDuration['>'](core.Duration.zero)) dart.assertFailed(null, I[1], 610, 12, "simulationDuration > Duration.zero");
      if (!!this.isAnimating) dart.assertFailed(null, I[1], 611, 12, "!isAnimating");
    ...
    repeat(opts) {
      ...
      if (!dart.fn(() => {
        ...
        return true;
      }, T.VoidTobool())()) dart.assertFailed(null, I[1], 640, 12, "() {\n      if (period == null) {\n        throw FlutterError(\n          'AnimationController.repeat() called without an explicit period and with no default Duration.\\n'\n          'Either the \"period\" argument to the repeat() method should be provided, or the '\n          '\"duration\" property should be set, either in the constructor or later, before '\n          'calling the repeat() function.',\n        );\n      }\n      return true;\n    }()");
      if (!(dart.notNull(max) >= dart.notNull(min))) dart.assertFailed(null, I[1], 651, 12, "max >= min");
      if (!(dart.notNull(max) <= this.upperBound && dart.notNull(min) >= this.lowerBound)) dart.assertFailed(null, I[1], 652, 12, "max <= upperBound && min >= lowerBound");
      if (!(reverse !== null)) dart.assertFailed(null, I[1], 653, 12, "reverse != null");
      this.stop();
    ...
    fling(opts) {
      ...
      if (!(simulation.type !== spring_simulation.SpringType.underDamped)) dart.assertFailed("The resulting spring simulation is of type SpringType.underDamped.\n" + "This can lead to unexpected look of the animation, please adjust the springDescription parameter", I[1], 706, 7, "simulation.type != SpringType.underDamped");
      this.stop();
      return this[_startSimulation](simulation);
    }
    animateWith(simulation) {
      if (!(this[_ticker] != null)) dart.assertFailed("AnimationController.animateWith() called after AnimationController.dispose()\n" + "AnimationController methods should not be used after calling dispose.", I[1], 730, 7, "_ticker != null");
      this.stop();
      this[_direction] = animation_controller._AnimationDirection.forward;
      return this[_startSimulation](simulation);
    }
    [_startSimulation](simulation) {
      if (!(simulation !== null)) dart.assertFailed(null, I[1], 740, 12, "simulation != null");
      if (!!this.isAnimating) dart.assertFailed(null, I[1], 741, 12, "!isAnimating");
    ...
    [_tick](elapsed) {
      ...
      if (!(elapsedInSeconds >= 0.0)) dart.assertFailed(null, I[1], 822, 12, "elapsedInSeconds >= 0.0");
  ...
  (animation_controller.AnimationController.new = function(opts) {
    ...
    if (!(lowerBound !== null)) dart.assertFailed(null, I[1], 241, 15, "lowerBound != null");
    if (!(upperBound !== null)) dart.assertFailed(null, I[1], 242, 15, "upperBound != null");
    if (!(upperBound >= lowerBound)) dart.assertFailed(null, I[1], 243, 15, "upperBound >= lowerBound");
    if (!(vsync !== null)) dart.assertFailed(null, I[1], 244, 15, "vsync != null");
    this[_direction] = animation_controller._AnimationDirection.forward;
  ...
  (animation_controller.AnimationController.unbounded = function(opts) {
    ...
    this[debugLabel$] = debugLabel;
    this[animationBehavior$] = animationBehavior;
    if (!(value !== null)) dart.assertFailed(null, I[1], 274, 15, "value != null");
    if (!(vsync !== null)) dart.assertFailed(null, I[1], 275, 15, "vsync != null");
    this[lowerBound$] = -1 / 0;
    this[upperBound$] = 1 / 0;
    this[_direction] = animation_controller._AnimationDirection.forward;
    animation_controller.AnimationController.__proto__.new.call(this);
  ...
  (animation_controller._InterpolationSimulation.new = function(_begin, _end, duration, _curve, scale) {
    ...
    this[_end$] = _end;
    this[_curve$] = _curve;
    if (!(_begin !== null)) dart.assertFailed(null, I[1], 846, 14, "_begin != null");
    if (!(_end !== null)) dart.assertFailed(null, I[1], 847, 14, "_end != null");
    if (!(duration !== null && duration.inMicroseconds > 0)) dart.assertFailed(null, I[1], 848, 14, "duration != null && duration.inMicroseconds > 0");
  ...
  animation_controller._RepeatingSimulation = class _RepeatingSimulation extends simulation.Simulation {
    ...
    x(timeInSeconds) {
      let t2, t2$;
      if (!(timeInSeconds >= 0.0)) dart.assertFailed(null, I[1], 897, 12, "timeInSeconds >= 0.0");
  ...
  (animation_controller._RepeatingSimulation.new = function(initialValue, min, max, reverse, period, directionSetter) {
    ...
    if (!(this[_periodInSeconds] > 0.0)) dart.assertFailed(null, I[1], 883, 12, "_periodInSeconds > 0.0");
    if (!(this[_initialT] >= 0.0)) dart.assertFailed(null, I[1], 884, 12, "_initialT >= 0.0");
