define(['dart_sdk', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/scheduler/binding.dart'], (function load__packages__flutter__src__painting__image_stream_dart(dart_sdk, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__scheduler__binding$46dart) {
  ...
  var I = [
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/painting/image_stream.dart",
  ...
  image_stream.ImageInfo = class ImageInfo extends core.Object {
    ...
    dispose() {
      let t0, t0$;
      if (!(dart.notNull((t0$ = (t0 = this.image.debugGetOpenHandleStackTraces(), t0 == null ? null : t0[$length]), t0$ == null ? 1 : t0$)) > 0)) dart.assertFailed(null, I[0], 125, 12, "(image.debugGetOpenHandleStackTraces()?.length ?? 1) > 0");
      this.image.dispose();
    }
    toString() {
  ...
  (image_stream.ImageChunkEvent.new = function(opts) {
    ...
    if (!(cumulativeBytesLoaded >= 0)) dart.assertFailed(null, I[0], 267, 15, "cumulativeBytesLoaded >= 0");
    if (!(expectedTotalBytes == null || dart.notNull(expectedTotalBytes) >= 0)) dart.assertFailed(null, I[0], 268, 15, "expectedTotalBytes == null || expectedTotalBytes >= 0");
    ;
  ...
  image_stream.ImageStream = class ImageStream extends Object_Diagnosticable$36$ {
    ...
    setCompleter(value) {
      if (!(this[_completer$] == null)) dart.assertFailed(null, I[0], 338, 12, "_completer == null");
    ...
    removeListener(listener) {
      ...
      if (!(this[_listeners] != null)) dart.assertFailed(null, I[0], 382, 12, "_listeners != null");
  ...
  image_stream.ImageStreamCompleterHandle = class ImageStreamCompleterHandle extends core.Object {
    ...
    dispose() {
      let t0;
      if (!(this[_completer$] != null)) dart.assertFailed(null, I[0], 445, 12, "_completer != null");
      if (!(dart.nullCheck(this[_completer$])[_keepAliveHandles] > 0)) dart.assertFailed(null, I[0], 446, 12, "_completer!._keepAliveHandles > 0");
      if (!!dart.nullCheck(this[_completer$])[_disposed]) dart.assertFailed(null, I[0], 447, 12, "!_completer!._disposed");
  ...
  image_stream.ImageStreamCompleter = class ImageStreamCompleter extends Object_Diagnosticable$36$0 {
    ...
    addOnLastListenerRemovedCallback(callback) {
      if (!(callback !== null)) dart.assertFailed(null, I[0], 607, 12, "callback != null");
      this[_checkDisposed]();
      this[_onLastListenerRemovedCallbacks][$add](callback);
    }
    removeOnLastListenerRemovedCallback(callback) {
      if (!(callback !== null)) dart.assertFailed(null, I[0], 615, 12, "callback != null");
      this[_checkDisposed]();
  ...
  (image_stream.OneFrameImageStreamCompleter.new = function(image, opts) {
    let informationCollector = opts && 'informationCollector' in opts ? opts.informationCollector : null;
    if (!(image !== null)) dart.assertFailed(null, I[0], 773, 16, "image != null");
  ...
  image_stream.MultiFrameImageStreamCompleter = class MultiFrameImageStreamCompleter extends image_stream.ImageStreamCompleter {
    ...
    [_handleCodecReady](codec) {
      this[_codec] = codec;
      if (!(this[_codec] != null)) dart.assertFailed(null, I[0], 888, 12, "_codec != null");
      if (this.hasListeners) {
    ...
    [_handleAppFrame](timestamp) {
      ...
      if (!(this[_nextFrame] != null)) dart.assertFailed(null, I[0], 899, 12, "_nextFrame != null");
    ...
    addListener(listener) {
      if (!this.hasListeners && this[_codec] != null && (this[_currentImage] == null || dart.nullCheck(this[_codec]).frameCount > 1)) this[_decodeNextFrameAndSchedule]();
    ...
    [_maybeDispose]() {
      ...
      super[_maybeDispose]();
      if (this[_disposed]) {
        t6 = this[_chunkSubscription];
        t6 == null ? null : t6.onData(null);
        t6$ = this[_chunkSubscription];
        t6$ == null ? null : t6$.cancel();
  ...
  (image_stream.MultiFrameImageStreamCompleter.new = function(opts) {
    ...
    this[_timer] = null;
    this[_frameCallbackScheduled] = false;
    if (!(codec !== null)) dart.assertFailed(null, I[0], 842, 15, "codec != null");
