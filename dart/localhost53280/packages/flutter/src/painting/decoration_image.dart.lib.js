define(['dart_sdk', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/painting/box_fit.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/painting/_network_image_web.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/image_stream.dart', 'packages/flutter/src/painting/debug.dart', 'packages/flutter/src/painting/binding.dart', 'packages/flutter/src/scheduler/binding.dart'], (function load__packages__flutter__src__painting__decoration_image_dart(dart_sdk, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__painting__box_fit$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__painting___network_image_web$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__image_stream$46dart, packages__flutter__src__painting__debug$46dart, packages__flutter__src__painting__binding$46dart, packages__flutter__src__scheduler__binding$46dart) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C[4] = dart.constList([C[0] || CT.C0, C[1] || CT.C1, C[2] || CT.C2, C[3] || CT.C3], decoration_image.ImageRepeat);
    },
    get C5() {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/painting/decoration_image.dart"
  ];
  ...
  decoration_image.DecorationImage = class DecorationImage extends core.Object {
    ...
    createPainter(onChanged) {
      if (!(onChanged !== null)) dart.assertFailed(null, I[1], 185, 12, "onChanged != null");
    ...
    get hashCode() {
      return ui.hashValues(this.image, this.colorFilter, this.fit, this.alignment, this.centerSlice, this.repeat, this.matchTextDirection, this.scale, this.opacity, this.filterQuality, this.invertColors, this.isAntiAlias);
    }
    toString() {
      let properties = (() => {
        let t0 = T.JSArrayOfString().of([dart.str(this.image)]);
        if (this.colorFilter != null) t0.push(dart.str(this.colorFilter));
        if (this.fit != null && !(this.fit === box_fit.BoxFit.fill && this.centerSlice != null) && !(this.fit === box_fit.BoxFit.scaleDown && this.centerSlice == null)) t0.push(dart.str(this.fit));
        t0.push(dart.str(this.alignment));
        if (this.centerSlice != null) t0.push("centerSlice: " + dart.str(this.centerSlice));
        if (this.repeat !== decoration_image.ImageRepeat.noRepeat) t0.push(dart.str(this.repeat));
        if (this.matchTextDirection) t0.push("match text direction");
        t0.push("scale " + dart.str(this.scale));
        t0.push("opacity " + dart.str(this.opacity));
        t0.push(dart.str(this.filterQuality));
        if (this.invertColors) t0.push("invert colors");
        if (this.isAntiAlias) t0.push("use anti-aliasing");
        return t0;
      })();
  ...
  (decoration_image.DecorationImage.new = function(opts) {
    ...
    if (!(image !== null)) dart.assertFailed(null, I[1], 60, 15, "image != null");
    if (!(alignment !== null)) dart.assertFailed(null, I[1], 61, 15, "alignment != null");
    if (!(repeat !== null)) dart.assertFailed(null, I[1], 62, 15, "repeat != null");
    if (!(matchTextDirection !== null)) dart.assertFailed(null, I[1], 63, 15, "matchTextDirection != null");
    if (!(scale !== null)) dart.assertFailed(null, I[1], 64, 15, "scale != null");
    ;
  ...
  decoration_image.DecorationImagePainter = class DecorationImagePainter extends core.Object {
    ...
    paint(canvas, rect, clipPath, configuration) {
      ...
      if (!newImageStream.key[$_equals]((t1 = this[_imageStream], t1 == null ? null : t1.key))) {
    ...
    [_handleImage](value, synchronousCall) {
      ...
      this[_image] = value;
      if (!(this[_onChanged$] !== null)) dart.assertFailed(null, I[1], 365, 12, "_onChanged != null");
  ...
  decoration_image.debugFlushLastFrameImageSizeInfo = function debugFlushLastFrameImageSizeInfo() {
    if (!dart.fn(() => {
      ...
      return true;
    }, T.VoidTobool())()) dart.assertFailed(null, I[1], 404, 10, "() {\n    _lastFrameImageSizeInfo = <ImageSizeInfo>{};\n    return true;\n  }()");
  };
  decoration_image.paintImage = function paintImage(opts) {
    ...
    let filterQuality = opts && 'filterQuality' in opts ? opts.filterQuality : C[6] || CT.C6;
    let isAntiAlias = opts && 'isAntiAlias' in opts ? opts.isAntiAlias : false;
    if (!(canvas !== null)) dart.assertFailed(null, I[1], 497, 10, "canvas != null");
    if (!(image !== null)) dart.assertFailed(null, I[1], 498, 10, "image != null");
    if (!(alignment !== null)) dart.assertFailed(null, I[1], 499, 10, "alignment != null");
    if (!(repeat !== null)) dart.assertFailed(null, I[1], 500, 10, "repeat != null");
    if (!(flipHorizontally !== null)) dart.assertFailed(null, I[1], 501, 10, "flipHorizontally != null");
    if (!(isAntiAlias !== null)) dart.assertFailed(null, I[1], 502, 10, "isAntiAlias != null");
    if (!dart.test((t1$ = (t1 = image.debugGetOpenHandleStackTraces(), t1 == null ? null : t1[$isNotEmpty]), t1$ == null ? true : t1$))) dart.assertFailed("Cannot paint an image that is disposed.\n" + "The caller of paintImage is expected to wait to dispose the image until " + "after painting has completed.", I[1], 504, 5, "image.debugGetOpenHandleStackTraces()?.isNotEmpty ?? true");
    ...
    if (!(centerSlice == null || fit !== box_fit.BoxFit.none && fit !== box_fit.BoxFit.cover)) dart.assertFailed(null, I[1], 520, 10, "centerSlice == null || (fit != BoxFit.none && fit != BoxFit.cover)");
    ...
    if (centerSlice != null) {
      ...
      if (!sourceSize._equals(inputSize)) dart.assertFailed("centerSlice was used with a BoxFit that does not guarantee that the image is fully visible.", I[1], 529, 12, "sourceSize == inputSize");
    }
    ...
    if (!false) {
      let sizeInfo = new debug.ImageSizeInfo.new({source: (t1$1 = debugImageLabel, t1$1 == null ? "<Unknown Image(" + dart.str(image.width) + "×" + dart.str(image.height) + ")>" : t1$1), imageSize: new ui.Size.new(image.width[$toDouble](), image.height[$toDouble]()), displaySize: outputSize['*'](dart.nullCheck(binding.PaintingBinding.instance).window.devicePixelRatio)});
      if (!dart.fn(() => {
        let t1;
  ...
  decoration_image._generateImageTileRects = function _generateImageTileRects(outputRect, fundamentalRect, repeat) {
    ...
    return (() => {
      let t2 = T.JSArrayOfRect().of([]);
      for (let i = startX; i <= stopX; i = i + 1)
        for (let j = startY; j <= stopY; j = j + 1)
          t2.push(fundamentalRect.shift(new ui.Offset.new(i * strideX, j * strideY)));
      return t2;
    })();
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["decoration_image.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;I