define(['dart_sdk', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/painting/edge_insets.dart', 'packages/flutter/src/foundation/collections.dart'], (function load__packages__flutter__src__painting__borders_dart(dart_sdk, packages__flutter__src__foundation__object$46dart, packages__flutter__src__painting__edge_insets$46dart, packages__flutter__src__foundation__collections$46dart) {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/painting/borders.dart"
  ];
  ...
  borders$.BorderSide = class BorderSide extends core.Object {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      return new borders$.BorderSide.new({color: color, width: width, style: style});
    }
    static merge(a, b) {
    ...
    static lerp(a, b, t) {
      ...
      return new borders$.BorderSide.new({color: dart.nullCheck(ui.Color.lerp(colorA, colorB, t)), width: width});
    }
    _equals(other) {
  ...
  borders$.ShapeBorder = class ShapeBorder extends core.Object {
    ...
    static lerp(a, b, t) {
      let t0;
      if (!(t !== null)) dart.assertFailed(null, I[1], 428, 12, "t != null");
      let result = null;
  ...
  (borders$.OutlinedBorder.new = function(opts) {
    ...
    this[side$] = side;
    if (!(side !== null)) dart.assertFailed(null, I[1], 501, 66, "side != null");
  ...
  borders$._CompoundBorder = class _CompoundBorder extends borders$.ShapeBorder {
    ...
    static lerp(a, b, t) {
      let t2;
      if (!(t !== null)) dart.assertFailed(null, I[1], 583, 12, "t != null");
      if (!(borders$._CompoundBorder.is(a) || borders$._CompoundBorder.is(b))) dart.assertFailed(null, I[1], 584, 12, "a is _CompoundBorder || b is _CompoundBorder");
  ...
  (borders$._CompoundBorder.new = function(borders) {
    ...
    if (!(borders !== null)) dart.assertFailed(null, I[1], 519, 14, "borders != null");
    if (!(borders[$length] >= 2)) dart.assertFailed(null, I[1], 520, 14, "borders.length >= 2");
    if (!!borders[$any](dart.fn(border => borders$._CompoundBorder.is(border), T.ShapeBorderTobool()))) dart.assertFailed(null, I[1], 521, 14, "!borders.any((ShapeBorder border) => border is _CompoundBorder)");
  ...
  borders$.paintBorder = function paintBorder(canvas, rect, opts) {
    ...
    if (!(canvas !== null)) dart.assertFailed(null, I[1], 679, 10, "canvas != null");
    if (!(rect !== null)) dart.assertFailed(null, I[1], 680, 10, "rect != null");
    if (!(top !== null)) dart.assertFailed(null, I[1], 681, 10, "top != null");
    if (!(right !== null)) dart.assertFailed(null, I[1], 682, 10, "right != null");
    if (!(bottom !== null)) dart.assertFailed(null, I[1], 683, 10, "bottom != null");
    if (!(left !== null)) dart.assertFailed(null, I[1], 684, 10, "left != null");
