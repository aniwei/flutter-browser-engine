define(['dart_sdk', 'packages/vector_math/vector_math_64.dart', 'packages/flutter/src/foundation/object.dart', 'packages/flutter/src/foundation/debug.dart', 'packages/flutter/src/painting/alignment.dart', 'packages/flutter/src/foundation/collections.dart'], (function load__packages__flutter__src__painting__gradient_dart(dart_sdk, packages__vector_math__vector_math_64$46dart, packages__flutter__src__foundation__object$46dart, packages__flutter__src__foundation__debug$46dart, packages__flutter__src__painting__alignment$46dart, packages__flutter__src__foundation__collections$46dart) {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/packages/flutter/lib/src/painting/gradient.dart"
  ];
  ...
  gradient.Gradient = class Gradient extends core.Object {
    ...
    [_impliedStops]() {
      ...
      if (!(this.colors[$length] >= 2)) dart.assertFailed("colors list must have at least two colors", I[1], 208, 12, "colors.length >= 2");
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 309, 12, "t != null");
      let result = null;
      if (b != null) result = b.lerpFrom(a, t);
      if (result == null && a != null) result = a.lerpTo(b, t);
      if (result != null) return result;
      if (a == null && b == null) return null;
      if (!(a != null && b != null)) dart.assertFailed(null, I[1], 319, 12, "a != null && b != null");
  ...
  (gradient.Gradient.new = function(opts) {
    ...
    if (!(colors !== null)) dart.assertFailed(null, I[1], 171, 15, "colors != null");
    ;
  ...
  gradient.LinearGradient = class LinearGradient extends gradient.Gradient {
    ...
    get hashCode() {
      return ui.hashValues(this.begin, this.end, this.tileMode, this.transform, ui.hashList(this.colors), ui.hashList(this.stops));
    }
    toString() {
      let description = (() => {
  ...
  (gradient.LinearGradient.new = function(opts) {
    ...
    if (!(begin !== null)) dart.assertFailed(null, I[1], 379, 15, "begin != null");
    if (!(end !== null)) dart.assertFailed(null, I[1], 380, 15, "end != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 381, 15, "tileMode != null");
  ...
  gradient.RadialGradient = class RadialGradient extends gradient.Gradient {
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 753, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return dart.nullCheck(b).scale(t);
      if (b == null) return a.scale(1.0 - t);
      let interpolated = gradient._interpolateColorsAndStops(a.colors, a[_impliedStops](), b.colors, b[_impliedStops](), t);
    ...
    get hashCode() {
      return ui.hashValues(this.center, this.radius, this.tileMode, this.transform, ui.hashList(this.colors), ui.hashList(this.stops), this.focal, this.focalRadius);
    }
    toString() {
      let description = (() => {
  ...
  (gradient.RadialGradient.new = function(opts) {
    ...
    if (!(center !== null)) dart.assertFailed(null, I[1], 622, 15, "center != null");
    if (!(radius !== null)) dart.assertFailed(null, I[1], 623, 15, "radius != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 624, 15, "tileMode != null");
    if (!(focalRadius !== null)) dart.assertFailed(null, I[1], 625, 15, "focalRadius != null");
  ...
  gradient.SweepGradient = class SweepGradient extends gradient.Gradient {
    ...
    static lerp(a, b, t) {
      if (!(t !== null)) dart.assertFailed(null, I[1], 1013, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return dart.nullCheck(b).scale(t);
      if (b == null) return a.scale(1.0 - t);
      let interpolated = gradient._interpolateColorsAndStops(a.colors, a[_impliedStops](), b.colors, b[_impliedStops](), t);
    ...
    get hashCode() {
      return ui.hashValues(this.center, this.startAngle, this.endAngle, this.tileMode, this.transform, ui.hashList(this.colors), ui.hashList(this.stops));
    }
    toString() {
      let description = (() => {
  ...
  (gradient.SweepGradient.new = function(opts) {
    ...
    if (!(center !== null)) dart.assertFailed(null, I[1], 910, 15, "center != null");
    if (!(startAngle !== null)) dart.assertFailed(null, I[1], 911, 15, "startAngle != null");
    if (!(endAngle !== null)) dart.assertFailed(null, I[1], 912, 15, "endAngle != null");
    if (!(tileMode !== null)) dart.assertFailed(null, I[1], 913, 15, "tileMode != null");
