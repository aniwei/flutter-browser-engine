define(['dart_sdk'], (function load__packages__vector_math__vector_math_64_dart(dart_sdk) {
  ...
  var I = [
    ...
    "file:///Users/weiyanhai/Desktop/env/flutter/.pub-cache/hosted/pub.dartlang.org/vector_math-2.1.1/lib/src/vector_math_64/matrix2.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/.pub-cache/hosted/pub.dartlang.org/vector_math-2.1.1/lib/src/vector_math_64/matrix3.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/.pub-cache/hosted/pub.dartlang.org/vector_math-2.1.1/lib/src/vector_math_64/matrix4.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/.pub-cache/hosted/pub.dartlang.org/vector_math-2.1.1/lib/src/vector_math_64/obb3.dart",
    "file:///Users/weiyanhai/Desktop/env/flutter/.pub-cache/hosted/pub.dartlang.org/vector_math-2.1.1/lib/src/vector_math_64/quaternion.dart"
  ];
  ...
  vector_math_64.SimplexNoise = class SimplexNoise extends core.Object {
    ...
    get [S._permMod12]() {
      let t1;
      t1 = this[S.__SimplexNoise__permMod12];
      return t1 == null ? dart.throw(new _internal.LateError.fieldNI("_permMod12")) : t1;
    }
    set [S._permMod12](t1) {
  ...
  vector_math_64.Vector4 = class Vector4 extends core.Object {
    ...
    set length(value) {
      ...
      if (value === 0.0) {
        ...
        t3$1 = 3;
        t2$1[S.$_set](t3$1, t2$1[S.$_get](t3$1) * l);
      }
    }
    get length() {
      return math.sqrt(this.length2);
    ...
    normalize() {
      ...
      t2$1 = this[S._v4storage];
      t3$1 = 3;
      t2$1[S.$_set](t3$1, t2$1[S.$_get](t3$1) * d);
      return l;
    }
    normalizeLength() {
      return this.normalize();
  ...
  vector_math_64.setModelMatrix = function setModelMatrix(modelMatrix, forwardDirection, upDirection, tx, ty, tz) {
    let t2;
    let right = (t2 = forwardDirection.cross(upDirection), (() => {
      t2.normalize();
      return t2;
    })());
    let c1 = right;
  ...
  vector_math_64.setViewMatrix = function setViewMatrix(viewMatrix, cameraPosition, cameraFocusPosition, upDirection) {
    let t2, t2$, t2$0;
    let z = (t2 = cameraPosition['-'](cameraFocusPosition), (() => {
      t2.normalize();
      return t2;
    })());
    let x = (t2$ = upDirection.cross(z), (() => {
      t2$.normalize();
      return t2$;
    })());
    let y = (t2$0 = z.cross(x), (() => {
      t2$0.normalize();
      return t2$0;
    })());
  ...
  vector_math_64.setPerspectiveMatrix = function setPerspectiveMatrix(perspectiveMatrix, fovYRadians, aspectRatio, zNear, zFar) {
    ...
    t2 = perspectiveMatrix;
    (() => {
      t2.setZero();
      t2.setEntry(0, 0, 1.0 / width);
      t2.setEntry(1, 1, 1.0 / height);
      t2.setEntry(2, 2, (zFar + zNear) / near_minus_far);
      t2.setEntry(3, 2, -1.0);
      t2.setEntry(2, 3, 2.0 * zNear * zFar / near_minus_far);
      return t2;
    })();
  };
  ...
  vector_math_64.setFrustumMatrix = function setFrustumMatrix(perspectiveMatrix, left, right, bottom, top, near, far) {
    ...
    (() => {
      t2.setZero();
      t2.setEntry(0, 0, two_near / right_minus_left);
      t2.setEntry(1, 1, two_near / top_minus_bottom);
      t2.setEntry(0, 2, (right + left) / right_minus_left);
      t2.setEntry(1, 2, (top + bottom) / top_minus_bottom);
      t2.setEntry(2, 2, -(far + near) / far_minus_near);
      t2.setEntry(3, 2, -1.0);
      t2.setEntry(2, 3, -(two_near * far) / far_minus_near);
      return t2;
    })();
  };
  ...
  vector_math_64.setOrthographicMatrix = function setOrthographicMatrix(orthographicMatrix, left, right, bottom, top, near, far) {
    ...
    let fmn = far - near;
    let fpn = far + near;
    t2 = orthographicMatrix;
    (() => {
      t2.setZero();
      t2.setEntry(0, 0, 2.0 / rml);
      t2.setEntry(1, 1, 2.0 / tmb);
      t2.setEntry(2, 2, -2.0 / fmn);
      t2.setEntry(0, 3, -rpl / rml);
      t2.setEntry(1, 3, -tpb / tmb);
      t2.setEntry(2, 3, -fpn / fmn);
      t2.setEntry(3, 3, 1.0);
      return t2;
    })();
  };
  ...
  vector_math_64.makePlaneReflection = function makePlaneReflection(planeNormal, planePoint) {
    let t2;
    let v = vector_math_64.Vector4.new(planeNormal.storage[S.$_get](0), planeNormal.storage[S.$_get](1), planeNormal.storage[S.$_get](2), 0.0);
    let outer = (t2 = vector_math_64.Matrix4.outer(v, v), (() => {
      t2.scale(2.0);
      return t2;
    })());
    let r = new vector_math_64.Matrix4.zero();
  ...
  vector_math_64.buildPlaneVectors = function buildPlaneVectors(planeNormal, u, v) {
    ...
    if (planeNormal.z[S.$abs]() > 0.7071067811865476) {
      ...
      (() => {
        t2.x = 0.0;
        t2.y = -planeNormal.z * k;
        t2.z = planeNormal.y * k;
        return t2;
      })();
      t2$ = v;
      (() => {
        t2$.x = a * k;
        t2$.y = -planeNormal._get(0) * (planeNormal._get(1) * k);
        t2$.z = planeNormal._get(0) * (-planeNormal._get(2) * k);
        return t2$;
      })();
    } else {
      ...
      t2$0 = u;
      (() => {
        t2$0.x = -planeNormal._get(1) * k;
        t2$0.y = planeNormal._get(0) * k;
        t2$0.z = 0.0;
        return t2$0;
      })();
      t2$1 = v;
      (() => {
        t2$1.x = -planeNormal._get(2) * (planeNormal._get(0) * k);
        t2$1.y = planeNormal._get(2) * (-planeNormal._get(1) * k);
        t2$1.z = a * k;
        return t2$1;
      })();
    }
